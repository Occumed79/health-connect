...
var getClosestRadiusCenter = function (point, direction, node) {
    var radiusCenters = (0, exports.getRectRadiusCircle)(node);
    var closestRadiusPoint;
    var minDistance = Number.MAX_SAFE_INTEGER;
    radiusCenters.forEach(function (item) {
        // 只有线段所在的水平线或垂直线经过该圆时，才能用圆弧求交点。
        var canIntersect = direction === constant_1.SegmentDirection.HORIZONTAL
    ...
    if (direction === constant_1.SegmentDirection.VERTICAL) {
        return {
            x: point.x,
