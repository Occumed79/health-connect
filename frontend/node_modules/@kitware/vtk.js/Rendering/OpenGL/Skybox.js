import { get, macros_exports, newInstance as newInstance$1, obj, setGet } from "../../macros.js";
...
//#region Sources/Rendering/OpenGL/Skybox/index.js
...
function vtkOpenGLSkybox(publicAPI, model) {
	...
	publicAPI.updateBufferObjects = () => {
		...
		if (model.renderable.getFormat() !== model.lastFormat) {
			...
			if (model.lastFormat === "box") model.tris.setProgram(model._openGLRenderWindow.getShaderCache().readyShaderProgramArray(`//VTK::System::Dec
			...
			if (model.lastFormat === "background") model.tris.setProgram(model._openGLRenderWindow.getShaderCache().readyShaderProgramArray(`//VTK::System::Dec
             attribute vec3 vertexMC;
             uniform mat4 IMCPCMatrix;
		...
		if (!tmaps.length) vtkErrorMacro("vtkSkybox requires a texture map");
...
function extend(publicAPI, model, initialValues = {}) {
	...
	model.openGLTexture = Texture_default.newInstance();
	model.tris = Helper_default.newInstance();
	model.keyMatrixTime = {};
	obj(model.keyMatrixTime, { mtime: 0 });
	model.keyMatrices = {
...
//#endregion
export { Skybox_default as default, extend, newInstance };
