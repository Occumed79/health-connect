...
var StreamingJSONParser = class extends JSONParser {
   ...
   */
  _isClosingDirectStreamingChild() {
    if (!this.streamingArray || this.currentState.container === this.streamingArray) {
      return false;
    }
    const parentState = this.previousStates[this.previousStates.length - 1];
    return (parentState == null ? void 0 : parentState.container) === this.streamingArray;
  }
  /**
