...
import { AddDataToMapPayload, ValueOf, Merge, PickInfo, RGBColor, NestedPartial, LayerVisConfig, ColorUI, Feature, FeatureSelectionContext, InteractionConfig, Filter, ParsedConfig, ParsedLayer, EffectPropsPartial, AnnotationPropsPartial, SyncTimelineMode, AnimationConfig, FilterAnimationConfig, LayerOrder, LayerOrderGroup } from '@kepler.gl/types';
 ...
 */
export declare function reorderLayer(order: LayerOrder): Merge<ReorderLayerUpdaterAction, {
...
export declare function addLayerGroup(payload: AddLayerGroupUpdaterAction): Merge<AddLayerGroupUpdaterAction, {
    type: typeof ActionTypes.ADD_LAYER_GROUP;
}>;
export type RemoveLayerGroupUpdaterAction = {
    id: string;
};
export declare function removeLayerGroup(payload: RemoveLayerGroupUpdaterAction): Merge<RemoveLayerGroupUpdaterAction, {
    type: typeof ActionTypes.REMOVE_LAYER_GROUP;
}>;
export type UpdateLayerGroupUpdaterAction = {
    id: string;
    options: Partial<Omit<LayerOrderGroup, 'id'>>;
};
export declare function updateLayerGroup(payload: UpdateLayerGroupUpdaterAction): Merge<UpdateLayerGroupUpdaterAction, {
    type: typeof ActionTypes.UPDATE_LAYER_GROUP;
}>;
export type AddLayerToLayerGroupUpdaterAction = {
    layerGroupId: string;
    layerId: string;
};
export declare function addLayerToLayerGroup(payload: AddLayerToLayerGroupUpdaterAction): Merge<AddLayerToLayerGroupUpdaterAction, {
    type: typeof ActionTypes.ADD_LAYER_TO_LAYER_GROUP;
}>;
export type RemoveLayerFromLayerGroupUpdaterAction = {
    layerGroupId: string;
    layerId: string;
};
export declare function removeLayerFromLayerGroup(payload: RemoveLayerFromLayerGroupUpdaterAction): Merge<RemoveLayerFromLayerGroupUpdaterAction, {
...
export declare function swapLayerOrderEntries(payload: SwapLayerOrderEntriesUpdaterAction): Merge<SwapLayerOrderEntriesUpdaterAction, {
    type: typeof ActionTypes.SWAP_LAYER_ORDER_ENTRIES;
}>;
 ...
 * @public
 */
export declare function addAnnotation(config?: AnnotationPropsPartial): Merge<AddAnnotationUpdaterAction, {
    type: typeof ActionTypes.ADD_ANNOTATION;
}>;
 ...
 * @public
 */
export declare function removeAnnotation(id: string): Merge<RemoveAnnotationUpdaterAction, {
    type: typeof ActionTypes.REMOVE_ANNOTATION;
}>;
 ...
 * @public
 */
export declare function updateAnnotation(id: string, config: AnnotationPropsPartial): Merge<UpdateAnnotationUpdaterAction, {
    type: typeof ActionTypes.UPDATE_ANNOTATION;
}>;
 ...
 * @public
 */
export declare function duplicateAnnotation(id: string): Merge<DuplicateAnnotationUpdaterAction, {
    type: typeof ActionTypes.DUPLICATE_ANNOTATION;
}>;
 ...
 * @public
 */
export declare function setSelectedAnnotation(id: string | null, isEditingText?: boolean): Merge<SetSelectedAnnotationUpdaterAction, {
    type: typeof ActionTypes.SET_SELECTED_ANNOTATION;
}>;
 ...
 * @returns action
 */
export declare function setPolygonFilterAllLayers(feature: Feature): Merge<SetPolygonFilterAllLayersUpdaterAction, {
