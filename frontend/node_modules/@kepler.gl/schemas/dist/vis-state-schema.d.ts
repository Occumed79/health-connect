...
import { AddDataToMapOptions, AnimationConfig, Editor, FileLoading, FileLoadingProgress, Filter, InteractionConfig, LayerOrder, MapInfo, ParsedFilter, ParsedLayer, ParsedVisState, SavedFilter, MinSavedFilter, SavedInteractionConfig, SavedLayer, MinSavedLayer, SavedVisState, SplitMap, ValueOf, Effect, Annotation } from '@kepler.gl/types';
...
export declare class AnnotationsSchema extends Schema {
    key: string;
    save(annotations: any): {
        [x: string]: any;
    };
    load(annotations: any): {
        [x: string]: any;
    };
}
