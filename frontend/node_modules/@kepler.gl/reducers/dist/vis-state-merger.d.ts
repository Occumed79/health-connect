 ...
 */
export declare function mergeLayerOrder<S extends VisState>(state: S, savedLayerOrder?: any[], fromConfig?: boolean): S;
/**
 ...
 */
export declare function mergeAnnotations<S extends VisState>(state: S, annotations: any[]): S;
/**
