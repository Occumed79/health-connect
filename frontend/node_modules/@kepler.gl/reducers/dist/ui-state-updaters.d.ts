import { ActionTypes, KeplerGlInitPayload, LoadFilesErrUpdaterAction, ReceiveMapConfigPayload, UIStateActions } from '@kepler.gl/actions';
import { ExportData, ExportHtml, ExportJson, ExportMap, ExportImage, ExportVideo, MapControls, UiState } from '@kepler.gl/types';
 ...
 * @public
 */
export declare const DEFAULT_EXPORT_VIDEO: ExportVideo;
/**
...
export declare const MUTUALLY_EXCLUSIVE_MAP_CONTROLS: string[];
/**
 ...
 * @public
 */
export declare const setExportVideoSettingUpdater: (state: UiState, { payload: newSetting }: UIStateActions.SetExportVideoSettingUpdaterAction) => UiState;
/**
 ...
 * @public
 */
export declare const receiveMapConfigUpdater: (state: UiState, { payload: { config } }: {
