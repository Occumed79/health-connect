...
import { loadFilesSuccessUpdaterAction, MapStyleChangeUpdaterAction, LayerTypeChangeUpdaterAction, ToggleSplitMapUpdaterAction, ReplaceDataInMapPayload, MapStateActions } from '@kepler.gl/actions';
 ...
 */
export declare function syncGlobeConfigColorsToStyle(mapState: MapState, mapStyle: MapStyle, styleType: string): MapState;
/**
 ...
 */
export declare const combinedSetMapViewModeUpdater: (state: KeplerGlState, action: MapStateActions.SetMapViewModeUpdaterAction) => KeplerGlState;
/**
 ...
 */
export declare const setMapSplitModeUpdater: (state: KeplerGlState, action: MapStateActions.SetMapSplitModeUpdaterAction) => KeplerGlState;
/**
