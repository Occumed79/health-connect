...
import { Filter, InteractionConfig, AnimationConfig, FilterAnimationConfig, Editor, Annotation } from '@kepler.gl/types';
 ...
 * @public
 */
export declare const addLayerGroupUpdater: (state: VisState, action: VisStateActions.AddLayerGroupUpdaterAction) => VisState;
/**
 * Remove a layer group and all layers within it
 * @memberof visStateUpdaters
 * @public
 */
export declare const removeLayerGroupUpdater: (state: VisState, action: VisStateActions.RemoveLayerGroupUpdaterAction) => VisState;
/**
 * Update a layer group (label, visibility, layer membership)
 * @memberof visStateUpdaters
 * @public
 */
export declare const updateLayerGroupUpdater: (state: VisState, action: VisStateActions.UpdateLayerGroupUpdaterAction) => VisState;
/**
 * Add a layer to a layer group
 * @memberof visStateUpdaters
 * @public
 */
export declare const addLayerToLayerGroupUpdater: (state: VisState, action: VisStateActions.AddLayerToLayerGroupUpdaterAction) => VisState;
/**
 * Remove a layer from a layer group
 * @memberof visStateUpdaters
 * @public
 */
export declare const removeLayerFromLayerGroupUpdater: (state: VisState, action: VisStateActions.RemoveLayerFromLayerGroupUpdaterAction) => VisState;
/**
 * Swap layer order entries between root and groups
 * @memberof visStateUpdaters
 * @public
 */
export declare const swapLayerOrderEntriesUpdater: (state: VisState, action: VisStateActions.SwapLayerOrderEntriesUpdaterAction) => VisState;
/**
 * duplicate layer
 * @memberof visStateUpdaters
 * @public
 ...
 * @public
 */
export declare const addAnnotationUpdater: (state: VisState, action: VisStateActions.AddAnnotationUpdaterAction) => VisState;
/**
 * Remove an annotation
 * @memberof visStateUpdaters
 * @public
 */
export declare const removeAnnotationUpdater: (state: VisState, { id }: VisStateActions.RemoveAnnotationUpdaterAction) => VisState;
/**
 * Update an annotation
 * @memberof visStateUpdaters
 * @public
 */
export declare const updateAnnotationUpdater: (state: VisState, { id, config }: VisStateActions.UpdateAnnotationUpdaterAction) => VisState;
/**
 * Duplicate an annotation
 * @memberof visStateUpdaters
 * @public
 */
export declare const duplicateAnnotationUpdater: (state: VisState, { id }: VisStateActions.DuplicateAnnotationUpdaterAction) => VisState;
/**
 * Set selected annotation
 * @memberof visStateUpdaters
 * @public
 */
export declare const setSelectedAnnotationUpdater: (state: VisState, { id, isEditingText }: VisStateActions.SetSelectedAnnotationUpdaterAction) => VisState;
/**
 ...
 * @memberof visStateUpdaters
 */
export declare function setPolygonFilterAllLayersUpdater(state: VisState, payload: VisStateActions.SetPolygonFilterAllLayersUpdaterAction): VisState;
/**
 * @memberof visStateUpdaters
 * @public
 */
