...
declare namespace ModalContainerFactory {
    ...
    }) | typeof ExportMapModalFactory | (() => React.FC<import("./modals/export-video-modal").ExportVideoModalProps>) | typeof AddMapStyleModalFactory | (() => import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("./common/modal").ModalDialogOwnProps & Omit<import("react-modal").Props, "className" | "style" | "ariaHideApp"> & React.RefAttributes<import("./common/modal").ModalDialog>, never> & Partial<Pick<import("./common/modal").ModalDialogOwnProps & Omit<import("react-modal").Props, "className" | "style" | "ariaHideApp"> & React.RefAttributes<import("./common/modal").ModalDialog>, never>>> & string & Omit<typeof import("./common/modal").ModalDialog, keyof React.Component<any, {}, any>>) | typeof SaveMapModalFactory)[];
}
