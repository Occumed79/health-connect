...
declare function LayerTimelineFactory(LayerTypeListItem: any): React.ForwardRefExoticComponent<Omit<{
    layers: any;
    theme: any;
    onDelete: any;
}, keyof import("styled-components").ExecutionProps> & import("styled-components").ExecutionProps & React.RefAttributes<any>> & import("styled-components/dist/utils/hoist").NonReactStatics<({ layers, theme, onDelete }: {
    layers: any;
    theme: any;
    onDelete: any;
}) => React.JSX.Element>;
