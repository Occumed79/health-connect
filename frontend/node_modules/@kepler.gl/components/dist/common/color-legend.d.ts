...
export declare function ResetColorLabelFactory(): import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<Partial<import("./icons").BaseProps> & React.RefAttributes<Reset>, never> & Partial<Pick<Partial<import("./icons").BaseProps> & React.RefAttributes<Reset>, never>>> & string & Omit<typeof Reset, keyof React.Component<any, {}, any>>;
