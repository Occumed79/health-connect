...
import ScenegraphModelSelectorFactory from './scenegraph-model-selector';
...
export declare const getLayerConfiguratorProps: (props: LayerConfiguratorProps) => {
    ...
    setLayerTextLabel: (idx: number | "all", prop: string, value: any) => void;
};
