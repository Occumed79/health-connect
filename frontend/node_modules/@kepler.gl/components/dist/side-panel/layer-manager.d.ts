...
declare function LayerManagerFactory(LayerList: ReturnType<typeof LayerListFactory>, DatasetLayerGroup: ReturnType<typeof DatasetLayerGroupFactory>, PanelViewListToggle: ReturnType<typeof PanelViewListToggleFactory>, PanelTitle: ReturnType<typeof PanelTitleFactory>, DatasetSection: ReturnType<typeof DatasetSectionFactory>, AddLayerButton: ReturnType<typeof AddLayerButtonFactory>, InfoHelper: ReturnType<typeof InfoHelperFactory>, PanelHeaderAction: ReturnType<typeof PanelHeaderActionFactory>): React.FC<import("react-intl").WithIntlProps<LayerManagerProps>> & {
    WrappedComponent: React.ComponentType<LayerManagerProps>;
};
declare namespace LayerManagerFactory {
    var deps: (typeof InfoHelperFactory | typeof PanelHeaderActionFactory | typeof LayerListFactory | typeof DatasetLayerGroupFactory | typeof PanelViewListToggleFactory | (() => React.FC<import("./panel-title").PanelTitleProps>) | typeof DatasetSectionFactory | typeof AddLayerButtonFactory)[];
}
