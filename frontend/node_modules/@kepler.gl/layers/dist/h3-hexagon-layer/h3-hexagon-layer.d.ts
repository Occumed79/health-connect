...
export default class HexagonIdLayer extends Layer {
    ...
    getDefaultLayerConfig(props: LayerBaseConfigPartial): {
        ...
        textLabel: {
            ...
            backgroundColor: import("@kepler.gl/types").RGBAColor | null;
        }[];
        dataId: string;
        label: string;
        color: import("@kepler.gl/types").RGBColor;
        ...
        aggregatedBins?: Record<number, import("@kepler.gl/types").AggregatedBin>;
        columnMode?: string;
