 ...
 */
export declare function getEditorLayer({ editorMenuActive, editor, onSetFeatures, setSelectedFeature, onApplyPolygonFilterAll, featureCollection, selectedFeatureIndexes, viewport, mapState }: GetEditorLayerProps): DeckLayer<DeckLayerProps>;
