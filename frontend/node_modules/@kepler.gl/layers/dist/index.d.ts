...
export { defaultLineWidth as tripDefaultLineWidth, COLUMN_MODE_GEOJSON } from './trip-layer/trip-layer';
...
export declare const KeplerGlLayers: {
    ...
    BitmapOverlayLayer: typeof BitmapOverlayLayer;
};
