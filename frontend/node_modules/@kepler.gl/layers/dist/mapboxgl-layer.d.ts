...
declare class MapboxLayerGL extends Layer {
    ...
    sourceSelector: ((state: {
        ...
        aggregatedBins?: Record<number, import("@kepler.gl/types").AggregatedBin> | undefined;
        ...
        lastResult: () => string;
        dependencies: [(config: MapboxLayerGLConfig) => string, (config: MapboxLayerGLConfig) => string];
    ...
    filterSelector: ((state: {
        ...
        heightDomain?: import("@kepler.gl/types").VisualChannelDomain | undefined;
        heightScale?: string | undefined;
    }, datasets: any) => any[] | null) & {
        clearCache: () => void;
        resultsCount: () => number;
        resetResultsCount: () => void;
    } & {
        resultFunc: (resultFuncArgs_0: any) => any[] | null;
        memoizedResultFunc: ((resultFuncArgs_0: any) => any[] | null) & {
            clearCache: () => void;
            resultsCount: () => number;
            resetResultsCount: () => void;
        };
        lastResult: () => any[] | null;
        dependencies: [(config: MapboxLayerGLConfig, datasets: any) => any];
        recomputations: () => number;
        resetRecomputations: () => void;
        dependencyRecomputations: () => number;
        resetDependencyRecomputations: () => void;
