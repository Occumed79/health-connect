 ...
 */
export declare function getDataType(usableAssets: CompleteSTACAssetLinks, typesToCheck?: string[]): DataTypeOfTheBand | null;
/**
 ...
 */
export declare function getBandIdsForCommonNames(stac: CompleteSTACObject, usableAssets: CompleteSTACAssetLinks, commonNames: string[], bandOverrides?: Record<string, string> | null): AssetRequestInfo | null;
/**
