...
export declare const getSingleTextLabelValue: ({ field, format }: {
    field: any;
    format?: string;
}, datum: {
    index: number;
} | any[] | null) => string;
export declare const getMultiTextLabelValue: (textLabelField: {
    field: any;
    format?: string;
}[], datum: {
    index: number;
} | any[] | null) => string;
export declare const formatTextLabelData: ({ textLabel, triggerChanged, oldLayerData, data, dataContainer, filteredIndex, textLabelAccessor: customTextLabelAccessor }: {
    textLabel: any;
