  ...
  return (0, _createClass2["default"])(ThreeDBuildingLayer, [{
    ...
    function renderSubLayers(props) {
      return new _layers.SolidPolygonLayer(_objectSpread(_objectSpread({}, props), {}, {
        parameters: _constants.BLEND_PARAMS_ALPHA,
        extruded: true,
        opacity: 1,
        filled: true,
