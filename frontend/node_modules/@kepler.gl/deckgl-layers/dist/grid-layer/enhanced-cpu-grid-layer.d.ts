...
import { GetPickingInfoParams, Layer, PickingInfo } from '@deck.gl/core';
/**
...
export default class ScaleEnhancedGridLayer extends GridLayer<any> {
    static defaultProps: {
        ...
        _subLayerProps?: ({
            ...
            [subLayerId: string]: {
                [propName: string]: any;
                type?: import("@deck.gl/core")._ConstructorOf<Layer>;
            };
        } | ({
            value: {
                [subLayerId: string]: {
    ...
    renderLayers(): any;
    _updateBinOptions(): void;
    getSubLayerClass<T extends Layer>(subLayerId: string, DefaultLayerClass: {
        new (...args: any[]): T;
    }): import("@deck.gl/core")._ConstructorOf<T>;
