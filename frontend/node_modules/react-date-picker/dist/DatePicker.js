...
export default function DatePicker(props) {
    ...
    const onOutsideAction = useCallback((event) => {
        ...
        if (target &&
            ...
            !(calendarWrapperEl === null || calendarWrapperEl === void 0 ? void 0 : calendarWrapperEl.contains(target))) {
