...
export default function MonthSelect({ ariaLabel, autoFocus, className, disabled, form, inputRef, locale, maxDate, minDate, onChange, onKeyDown, placeholder = '--', required, short, value, year, }) {
    ...
    return (_jsxs("select", { "aria-label": ariaLabel, 
        ...
        autoFocus: autoFocus, className: clsx(`${className}__input`, `${className}__${name}`), "data-input": "true", "data-select": "true", disabled: disabled, form: form, name: name, onChange: onChange, onKeyDown: onKeyDown, 
