...
| customInputsForm     | `form` attribute for the custom day, month, and year inputs. Set to an empty string to exclude these inputs from their nearest ancestor form.                                                                                                                                                                                              | n/a                                   | `"my-form"`                                                                                                                                                                                                         |
