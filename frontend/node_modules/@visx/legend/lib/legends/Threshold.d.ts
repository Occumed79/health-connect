 ...
 */
export default function Threshold<Scale extends AnyThresholdScale>({ scale, domain: inputDomain, labelFormat, labelTransform: inputLabelTransform, labelDelimiter, labelLower, labelUpper, ...restProps }: LegendThresholdProps<Scale>): import("react/jsx-runtime").JSX.Element;
export {};
