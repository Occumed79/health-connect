...
export default function LegendItem({ flexDirection, alignItems, margin, display, children, ...restProps }: LegendItemProps & Omit<HTMLProps<HTMLDivElement>, keyof LegendItemProps>): import("react/jsx-runtime").JSX.Element;
