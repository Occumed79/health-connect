...
export default function Polygon({ polygon, className, children, ...restProps }: PolygonProps & Omit<SVGProps<SVGPathElement>, keyof PolygonProps>): import("react/jsx-runtime").JSX.Element | null;
