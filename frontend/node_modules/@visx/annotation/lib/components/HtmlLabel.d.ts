...
export default function HtmlLabel({ anchorLineStroke, children, className, containerStyle, horizontalAnchor: propsHorizontalAnchor, resizeObserverPolyfill, showAnchorLine, verticalAnchor: propsVerticalAnchor, x: propsX, y: propsY, }: HtmlLabelProps): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=HtmlLabel.d.ts.map