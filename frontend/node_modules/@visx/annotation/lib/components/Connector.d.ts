...
export default function Connector({ className, x: propsX, y: propsY, dx: propsDx, dy: propsDy, type, stroke, pathProps, }: ConnectorProps): import("react/jsx-runtime").JSX.Element;
