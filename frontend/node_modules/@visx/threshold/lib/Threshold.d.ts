...
export default function Threshold<Datum>({ className, curve, clipAboveTo, clipBelowTo, data, defined, x, y0, y1, aboveAreaProps, belowAreaProps, id, }: ThresholdProps<Datum>): import("react/jsx-runtime").JSX.Element;
export {};
