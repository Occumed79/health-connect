...
export default function Pack<Datum>({ top, left, className, root, radius, size, padding, children, nodeComponent, }: PackProps<Datum>): import("react/jsx-runtime").JSX.Element;
