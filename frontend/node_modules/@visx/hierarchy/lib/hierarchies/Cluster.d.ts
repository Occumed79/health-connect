...
export default function Cluster<Datum>({ top, left, className, root, size, nodeSize, separation, children, linkComponent, nodeComponent, }: ClusterProps<Datum>): import("react/jsx-runtime").JSX.Element;
