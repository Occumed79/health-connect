...
export type ResizeTriggerAreas = 'left' | 'right' | 'top' | 'bottom' | 'topLeft' | 'topRight' | 'bottomLeft' | 'bottomRight';
...
export type Scale<Output extends BrushScaleOutput = BrushScaleOutput> = D3Scale<Output, any, any>;
export {};
