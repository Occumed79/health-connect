...
export type SeriesProps<XScale extends AxisScale, YScale extends AxisScale, Datum extends object> = {
...
export type BarStackDatum<XScale extends AxisScale, YScale extends AxisScale> = SeriesPoint<CombinedStackData<XScale, YScale>>;
export type BarStackData<XScale extends AxisScale, YScale extends AxisScale> = Series<CombinedStackData<XScale, YScale>, string>[];
...
/** Glyphs */
export type GlyphsProps<XScale extends AxisScale, YScale extends AxisScale, Datum extends object> = {
    xScale: XScale;
    yScale: YScale;
    horizontal?: boolean;
