...
export default function BaseBarSeriesWithRegisteredData<XScale extends AxisScale, YScale extends AxisScale, Datum extends object>(props: BaseBarSeriesProps<XScale, YScale, Datum>): import("react/jsx-runtime").JSX.Element | null;
