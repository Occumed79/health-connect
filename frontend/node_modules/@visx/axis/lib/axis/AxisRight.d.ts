...
export default function AxisRight<Scale extends AxisScale>({ axisClassName, labelOffset, tickLength, tickLabelProps, ...restProps }: AxisRightProps<Scale>): import("react/jsx-runtime").JSX.Element;
