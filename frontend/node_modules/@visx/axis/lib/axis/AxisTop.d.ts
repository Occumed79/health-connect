...
export default function AxisTop<Scale extends AxisScale>({ axisClassName, labelOffset, tickLength, tickLabelProps, ...restProps }: AxisTopProps<Scale>): import("react/jsx-runtime").JSX.Element;
