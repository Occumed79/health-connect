...
number) {
  let random = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultRandom;
  let randomOffset = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : defaultRandomOffset;
  const data = [];
