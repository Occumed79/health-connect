...
export default function RectClipPath({ id, x, y, width, height, ...restProps }: RectClipPathProps & Omit<SVGProps<SVGRectElement>, keyof RectClipPathProps>): import("react/jsx-runtime").JSX.Element;
