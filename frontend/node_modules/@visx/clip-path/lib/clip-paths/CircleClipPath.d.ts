...
export default function CircleClipPath({ id, cx, cy, r, ...restProps }: CircleClipPathProps & Omit<SVGProps<SVGCircleElement>, keyof CircleClipPathProps>): import("react/jsx-runtime").JSX.Element;
