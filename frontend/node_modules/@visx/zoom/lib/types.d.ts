...
import type { RefObject, MouseEvent as ReactMouseEvent, TouchEvent as ReactTouchEvent, PointerEvent as ReactPointerEvent, WheelEvent as ReactWheelEvent } from 'react';
export type GenericWheelEvent = ReactWheelEvent | WheelEvent;
export type InteractionEvent = ReactMouseEvent | ReactTouchEvent | ReactPointerEvent | MouseEvent | TouchEvent | PointerEvent;
...
export type PinchDelta = (params: Parameters<Handler<'pinch', TouchEvent | ReactTouchEvent | PointerEvent | ReactPointerEvent | WheelEvent | ReactWheelEvent | WebKitGestureEvent>>[0]) => Scale;
...
export interface ProvidedZoom<ElementType> {
    ...
    dragMove: (event: InteractionEvent, options?: {
        offsetX?: number;
        offsetY?: number;
    }) => void;
