...
export default function VoronoiPolygon({ polygon, className, children, ...restProps }: VoronoiPolygonProps & Omit<SVGProps<SVGPathElement>, keyof VoronoiPolygonProps>): import("react/jsx-runtime").JSX.Element | null;
