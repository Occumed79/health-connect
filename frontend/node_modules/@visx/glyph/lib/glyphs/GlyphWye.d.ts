...
export default function GlyphWye<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphWyeProps<Datum> & Omit<SVGProps<SVGPathElement>, keyof GlyphWyeProps<Datum>>): import("react/jsx-runtime").JSX.Element;
