...
export default function GlyphTriangle<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphTriangleProps<Datum> & Omit<SVGProps<SVGPathElement>, keyof GlyphTriangleProps<Datum>>): import("react/jsx-runtime").JSX.Element;
