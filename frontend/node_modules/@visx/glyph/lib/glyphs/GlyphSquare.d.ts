...
export default function GlyphSquare<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphSquareProps<Datum> & Omit<SVGProps<SVGPathElement>, keyof GlyphSquareProps<Datum>>): import("react/jsx-runtime").JSX.Element;
