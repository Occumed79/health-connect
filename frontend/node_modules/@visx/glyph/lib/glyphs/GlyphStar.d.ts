...
export default function GlyphStar<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphStarProps<Datum> & Omit<SVGProps<SVGPathElement>, keyof GlyphStarProps<Datum>>): import("react/jsx-runtime").JSX.Element;
