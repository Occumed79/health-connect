import { Position, Point, SimpleGeometry, Feature } from "../utils/geojson-types.js";
import type { EditModeCoordinateSystem } from "./coordinate-system.js";
...
export type EditHandleFeature = Feature<Point, {
...
export type TentativeFeature = Feature<SimpleGeometry, {
    guideType: 'tentative';
    shape?: string;
}>;
