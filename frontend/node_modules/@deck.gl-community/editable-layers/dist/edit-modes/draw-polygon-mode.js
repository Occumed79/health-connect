...
import { cartesianCoordinateSystem, CartesianCoordinateSystem } from "./coordinate-system.js";
import { polygonEdgesIntersect, polygonWithinPolygon } from "./cartesian-utils.js";
...
function isContainingOrContained(poly1, poly2, coordSystem) {
    return forCoordSystem(coordSystem, () => booleanWithin(poly1, poly2) || booleanWithin(poly2, poly1), () => polygonWithinPolygon(poly1, poly2) || polygonWithinPolygon(poly2, poly1));
}
function isPolygonIntersecting(poly1, poly2, coordSystem) {
    return forCoordSystem(coordSystem, () => lineIntersect(poly1, poly2).features.length > 0, () => polygonEdgesIntersect(poly1, poly2));
}
function isPolygonWithin(poly1, poly2, coordSystem) {
    return forCoordSystem(coordSystem, () => booleanWithin(poly1, poly2), () => polygonWithinPolygon(poly1, poly2));
}
