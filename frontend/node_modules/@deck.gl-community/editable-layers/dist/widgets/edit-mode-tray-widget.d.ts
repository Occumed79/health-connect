...
import type { GeoJsonEditModeConstructor, GeoJsonEditModeType } from "../edit-modes/geojson-edit-mode.js";
...
export declare class EditModeTrayWidget extends Widget<EditModeTrayWidgetProps> {
    static defaultProps: {
        id: string;
        _container: any;
        placement: "top-left";
    ...
    setProps(props: Partial<EditModeTrayWidgetProps>): void;
    onAdd({ deck }: {
        deck: Deck;
    }): void;
    onRemove(): void;
...
//# sourceMappingURL=edit-mode-tray-widget.d.ts.map