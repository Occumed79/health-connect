    ...
    getAddFeatureOrBooleanPolygonAction(geometry) {
        ...
        if (modeConfig && modeConfig.booleanOperation) {
            ...
            if (modeConfig.booleanOperation === 'union') {
                updatedGeometry = union(turfFeatureCollection([selectedFeature, feature]));
            }
            else if (modeConfig.booleanOperation === 'difference') {
                updatedGeometry = difference(turfFeatureCollection([selectedFeature, feature]));
            }
            else if (modeConfig.booleanOperation === 'intersection') {
                updatedGeometry = intersect(turfFeatureCollection([selectedFeature, feature]));
            }
            else {
                // eslint-disable-next-line no-console,no-undef
