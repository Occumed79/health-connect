...
var InputContainer = import_styled_components.styled.div`
  position: relative;
  width: 100%;
  font:
    14px / 20px Helvetica,
...
var Base = class extends import_react3.Component {
  render() {
...
__publicField(Base, "displayName", "Base Icon");
__publicField(Base, "propTypes", {
...
__publicField(Base, "defaultProps", {
  height: null,
  width: null,
  viewBox: "0 0 64 64",
  predefinedClassName: "",
...
// dist/components/icons/play.js
var Play = class extends import_react4.Component {
  render() {
...
__publicField(Play, "propTypes", {
  /** Set the height of the icon, ex. '16px' */
  height: import_prop_types2.default.string
});
__publicField(Play, "defaultProps", {
  height: "16px",
...
__publicField(Stop, "propTypes", {
  /** Set the height of the icon, ex. '16px' */
  height: import_prop_types3.default.string
});
__publicField(Stop, "defaultProps", {
  height: "16px",
...
var DownloadVideo = class extends import_react6.Component {
  render() {
...
__publicField(DownloadVideo, "propTypes", {
  /** Set the height of the icon, ex. '16px' */
  height: import_prop_types4.default.string
});
__publicField(DownloadVideo, "defaultProps", {
  height: "16px",
...
var VideoPlayer = import_styled_components2.styled.video`
  margin: 8px 0;
  width: 100%;
`;
var GifPlayer = import_styled_components2.styled.img`
  margin: 8px 0;
  width: 100%;
`;
var ScrollBox = import_styled_components2.styled.div`
  width: 500px;
  height: 400px;
  position: relative;
  overflow: auto;
  margin: 8px 0;
`;
var ImageGallery = import_styled_components2.styled.div`
  display: flex;
  flex-wrap: wrap;
  gap: 8px;
`;
var Thumbnail = import_styled_components2.styled.img`
  width: 64px;
`;
...
// dist/components/basic-controls.js
var RenderResult = import_styled_components3.styled.div`
  position: absolute;
  z-index: 1;
  top: 0;
  right: 0;
...
`;
var RenderControls = import_styled_components3.styled.div``;
var ButtonGroup = import_styled_components3.styled.div`
  display: flex;
  flex-wrap: wrap;
  gap: 8px;
  margin-top: 8px;
...
`;
var Result = import_styled_components3.styled.div`
  display: ${(props) => props.$show ? "block" : "none"};
  max-width: 500px;
`;
var Status = import_styled_components3.styled.div`
  display: flex;
  align-items: center;
`;
var H3 = import_styled_components3.styled.h3`
  font-size: 16px;
  margin: 8px 0;
  font-family: Helvetica, Arial, sans-serif;
`;
var Download = import_styled_components3.styled.div`
  color: blue;
  cursor: pointer;
  padding: 0 8px;
  display: ${(props) => props.$show ? "flex" : "none"};
`;
var TogglePlayer = import_styled_components3.styled.div`
  font-family: Helvetica, Arial, sans-serif;
  display: inline-block;
  user-select: none;
  margin: 8px 0;
...
// dist/components/export-video/styled-components.js
var SliderWrapper = import_styled_components4.styled.div`
  display: flex;
  position: relative;
  flex-grow: 1;
  margin-right: 24px;
  margin-left: 24px;
`;
var StyledLabelCell = import_styled_components4.styled.div`
  align-self: center;
  color: ${(props) => props.theme.labelColor};
  font-weight: 400;
  font-size: 11px;
`;
var StyledValueCell = import_styled_components4.styled.div`
  align-self: center;
  ...
  padding: 0 12px;
`;
var InputGrid = import_styled_components4.styled.div`
  display: grid;
...
`;
var ButtonGroup2 = import_styled_components4.styled.div`
  display: flex;
`;
var ModalContainer = import_styled_components4.styled.div`
  position: relative;
`;
var PanelCloseInner = import_styled_components4.styled.div`
  display: flex;
  justify-content: flex-end;
`;
var StyledTitle = import_styled_components4.styled.div`
...
var LoaderWrapper = import_styled_components4.styled.div`
  ...
  justify-content: center;
`;
var RenderingFeedbackContainer = import_styled_components4.styled.div`
  color: white;
  position: absolute;
  top: ${(props) => props.$height - 180}px;
`;
var VideoLengthDisplay = import_styled_components4.styled.div`
  align-self: center;
  padding-left: 8px;
`;
var ExportVideoPanelHeader = import_styled_components4.styled.div`
  display: flex;
  justify-content: space-between;
`;
var DeckCanvas = import_styled_components4.styled.div`
  width: ${(props) => props.$width}px;
  height: ${(props) => props.$height}px;
  position: relative;
`;
...
var ExportVideoModal = class extends import_react10.Component {
  root = (0, import_react10.createRef)();
  ...
  settingsPosSelector = (0, import_reselect.createSelector)(this.showSettingsSelector, this.themeSelector, (showSettings, theme = {}) => {
  ...
  modalStylesSelector = (0, import_reselect.createSelector)(this.themeSelector, (theme) => ({
    content: {
      top: "auto",
      left: "auto",
      right: "50%",
...
__publicField(ExportVideoModal, "defaultProps", {
...
var import_react17 = __toESM(require("@deck.gl/react"), 1);
var import_react_map_gl = __toESM(require("react-map-gl"), 1);
var import_mapbox = require("@deck.gl/mapbox");
...
function createKeplerLayers(map, viewState, mapIndex = void 0, beforeId) {
  ...
  if (layerData && layerData.length) {
    return [...layerOrder].map((layerId) => ({ layerId, visible: layersToRender[layerId] })).reduce((overlays, layerMeta, idx) => renderLayer({ overlays, idx, map, viewState, isVisible: layerMeta.visible, beforeId }), []);
  }
  return [];
}
...
var DeckGLOverlay = (0, import_react16.forwardRef)((props, ref) => {
  const deck = (0, import_react_map_gl.useControl)(() => new import_mapbox.MapboxOverlay({ ...props, interleaved: true }));
  deck.setProps(props);
...
var ExportVideoPanelPreview = class extends import_react16.Component {
  ...
  render() {
    ...
    return import_react16.default.createElement(
      ...
      null,
      import_react16.default.createElement(DeckCanvas, { id: "deck-canvas", "$width": width, "$height": height }, disableBaseMap ? import_react16.default.createElement(import_react17.default, { ref: (ref) => setRef(this.deckRef, ref == null ? void 0 : ref.deck), ...adapter.getProps({ deck, extraProps: { ...deckProps, layers: keplerLayers } }), ...this._getContainer() }) : import_react16.default.createElement(
        ...
        import_react16.default.createElement(DeckGLOverlay, {
          ref: this.deckRef,
...
// dist/components/export-video/export-video-panel.js
var PanelClose = ({ handleClose }) => import_react18.default.createElement(WithKeplerUI, null, ({ IconButton, Icons }) => import_react18.default.createElement(
  PanelCloseInner,
  ...
  import_react18.default.createElement(
    ...
    import_react18.default.createElement(Icons.Delete, { height: DEFAULT_ICON_BUTTON_HEIGHT })
  )
));
var PanelBody = ({ exportVideoWidth, mapData, adapter, setViewState, settings, resolution, viewState, deckProps, mapProps, disableBaseMap, mapboxLayerBeforeId, handlePreviewVideo, handleRenderVideo, handleStop, rendering, previewing, saving }) => import_react18.default.createElement(WithKeplerUI, null, ({ Button }) => import_react18.default.createElement(
  PanelBodyInner,
  { className: "export-video-panel__body", "$exportVideoWidth": exportVideoWidth },
  import_react18.default.createElement(ExportVideoPanelPreview, { mapData, adapter, setViewState, exportVideoWidth, resolution, viewState, rendering, saving, durationMs: settings.durationMs, deckProps, mapProps, disableBaseMap, mapboxLayerBeforeId }),
  import_react18.default.createElement(export_video_panel_settings_default, { settings, resolution, disabled: rendering || previewing }),
  import_react18.default.createElement(TimelineControls, { className: "timeline-controls" }, rendering || previewing ? import_react18.default.createElement(Stop, { style: timelinePlayButtonStyle, onClick: () => handleStop({}) }) : import_react18.default.createElement(Play, { style: timelinePlayButtonStyle, onClick: handlePreviewVideo })),
  import_react18.default.createElement(
    ButtonGroup2,
    null,
    import_react18.default.createElement(Button, { style: { marginTop: "16px", width: "100%", height: "32px" }, className: "export-video-button", onClick: handleRenderVideo, disabled: rendering || previewing }, "Render")
  )
));
var ExportVideoPanel = ({
  ...
  return import_react18.default.createElement(
    ...
    header !== false ? import_react18.default.createElement(
      ExportVideoPanelHeader,
      { className: "export-video-panel__header" },
      import_react18.default.createElement(StyledTitle, { className: "export-video-panel__title" }, "Export Video"),
      import_react18.default.createElement(PanelClose, { handleClose })
    ) : null,
    import_react18.default.createElement(PanelBody, { exportVideoWidth, mapData, adapter, settings, setViewState, resolution, viewState, deckProps, mapProps, disableBaseMap, mapboxLayerBeforeId, handlePreviewVideo, handleRenderVideo, handleStop, rendering, previewing, saving })
  );
};
...
var ExportVideoPanelContainer = class extends import_react19.Component {
  constructor(props) {
    super(props);
...
var import_react22 = require("@deck.gl/react");

// dist/hooks.js
var import_react20 = require("react");
var import_core5 = require("@hubble.gl/core");
function useNextFrame() {
  const [, updateState] = (0, import_react20.useState)({});
  return (0, import_react20.useCallback)(() => updateState({}), []);
}
function useDeckAdapter(deckAnimation, initialViewState = void 0) {
  const [layers, setLayers] = (0, import_react20.useState)([]);
  const [cameraFrame, setCameraFrame] = (0, import_react20.useState)(initialViewState);
...
function useDeckAnimation(params) {
  return (0, import_react20.useMemo)(() => new import_core5.DeckAnimation(params), []);
}
function useHubbleGl({ deckRef, mapRef = void 0, deckAnimation, initialViewState = void 0 }) {
  const deck = (0, import_react20.useMemo)(() => deckRef.current, [deckRef.current]);
  const nextFrame = useNextFrame();
  const { adapter, layers, cameraFrame, setCameraFrame } = useDeckAdapter(deckAnimation, initialViewState);
  const onMapLoad = (0, import_react20.useCallback)(() => {
    if (mapRef) {
...
var QuickAnimation = ({ initialViewState, animation, timecode, resolution = { width: 640, height: 480 }, formatConfigs = {}, deckProps = {} }) => {
  const deckRef = (0, import_react21.useRef)(null);
  const deck = (0, import_react21.useMemo)(() => deckRef.current && deckRef.current.deck, [deckRef.current]);
  ...
  return import_react21.default.createElement(
    ...
    import_react21.default.createElement(
      "div",
      { style: { position: "relative" } },
      import_react21.default.createElement(import_react22.DeckGL, { ref: deckRef, style: { position: "unset" }, viewState: cameraFrame, onViewStateChange: ({ viewState: vs }) => setCameraFrame(vs), controller: true, width: resolution.width, height: resolution.height, layers, ...adapter.getProps({ deck, onNextFrame, extraProps: deckProps }) })
    ),
    import_react21.default.createElement(BasicControls, { adapter, busy, setBusy, formatConfigs: mergedFormatConfigs, timecode: mergedTimecode })
  );
};
