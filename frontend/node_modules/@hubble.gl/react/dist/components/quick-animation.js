...
export const QuickAnimation = ({ initialViewState, animation, timecode, resolution = { width: 640, height: 480 }, formatConfigs = {}, deckProps = {} }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { style: { position: 'relative' } },
            React.createElement(DeckGL, { ref: deckRef, style: { position: 'unset' }, viewState: cameraFrame, onViewStateChange: ({ viewState: vs }) => setCameraFrame(vs), controller: true, width: resolution.width, height: resolution.height, layers: layers, ...adapter.getProps({ deck, onNextFrame, extraProps: deckProps }) })),
...
//# sourceMappingURL=quick-animation.js.map