...
export declare class ExportVideoPanelContainer extends Component<ExportVideoPanelContainerProps, ExportVideoPanelContainerState> {
    ...
    getCameraKeyframes(): {
        ...
        keyframes: {
            ...
            transitionInterpolator?: import("@deck.gl/core").TransitionInterpolator;
            transitionEasing?: (t: number) => number;
            transitionInterruption?: 2 | 1 | 3;
            onTransitionStart?: (transition: import("@deck.gl/core/dist/transitions/transition").default) => void;
            onTransitionInterrupt?: (transition: import("@deck.gl/core/dist/transitions/transition").default) => void;
            onTransitionEnd?: (transition: import("@deck.gl/core/dist/transitions/transition").default) => void;
        }[];
