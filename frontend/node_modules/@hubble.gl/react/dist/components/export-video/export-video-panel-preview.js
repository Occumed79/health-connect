    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            , { 
                ...
                React.createElement(DeckGLOverlay, { ref: this.deckRef, 
                    // @ts-expect-error stencil is not recognized
                    deviceProps: { type: 'webgl', webgl: { stencil: true } }, ...adapter.getProps({ deck, extraProps: { ...deckProps, layers: keplerLayers } }) })))),
