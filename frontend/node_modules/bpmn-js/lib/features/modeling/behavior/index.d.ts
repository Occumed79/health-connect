declare const _default: {
  ...
  categoryRootElementReferenceBehavior: (string | typeof CategoryRootElementReferenceBehavior)[];
  ...
  updateCategoryValueRefsBehavior: (string | typeof UpdateCategoryValueRefsBehavior)[];
