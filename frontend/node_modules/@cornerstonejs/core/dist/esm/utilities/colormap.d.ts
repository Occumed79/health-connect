import type { ColormapPublic, ColormapRegistration } from '../types/index.js';
import type { OpacityMapping } from '../types/Colormap.js';
...
declare function resolveColormap(name?: string): ColormapRegistration | undefined;
