...
import { Events, ImageQualityStatus, MetadataModules, RequestType, } from '../../enums/index.js';
import eventTarget from '../../eventTarget.js';
import imageLoadPoolManager from '../../requestPool/imageLoadPoolManager.js';
import ProgressiveIterator from '../../utilities/ProgressiveIterator.js';
import imageRetrieveMetadataProvider from '../../utilities/imageRetrieveMetadataProvider.js';
import { hasFloatScalingParameters } from '../../utilities/hasFloatScalingParameters.js';
import autoLoad from '../../utilities/autoLoad.js';
import triggerEvent from '../../utilities/triggerEvent.js';
import ImageVolume from './ImageVolume.js';
...
export class BaseStreamingImageVolume extends ImageVolume {
    ...
    load(callback) {
        ...
        const { transferSyntaxUID } = metaData.get(MetadataModules.TRANSFER_SYNTAX, imageIds[0]) || {};
    ...
    getLoaderImageOptions(imageId) {
        const { transferSyntaxUID: transferSyntaxUID } = metaData.get(MetadataModules.TRANSFER_SYNTAX, imageId) || {};
        ...
        const generalSeriesModule = metaData.get(MetadataModules.GENERAL_SERIES, imageId) || {};
