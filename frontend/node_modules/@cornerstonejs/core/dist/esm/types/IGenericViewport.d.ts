import type { IViewport, ViewReference } from './IViewport.js';
import type ICamera from './ICamera.js';
import type ResolvedViewportView from '../RenderingEngine/GenericViewport/ResolvedViewportView.js';
export type ViewportContentMode = 'stack' | 'volume' | 'volume3d' | 'video' | 'wholeSlide' | 'ecg' | 'empty' | 'unknown';
