...
export function canvasToWorldPlanarCpuImage(enabledElement, imageData, canvasPos, worldPos = [0, 0, 0]) {
...
export function worldToCanvasPlanarCpuImage(enabledElement, imageData, worldPos) {
    const { origin, spacing, direction } = imageData;
    const iVector = direction.slice(0, 3);
    const jVector = direction.slice(3, 6);
    const [sourceX, sourceY] = getDisplayedAreaSource(enabledElement);
