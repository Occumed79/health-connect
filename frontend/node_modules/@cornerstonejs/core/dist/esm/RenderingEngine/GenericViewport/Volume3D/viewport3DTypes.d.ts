...
import type { GeometryOptions } from '../../../loaders/geometryLoader.js';
import type { ActorEntry, ICamera, IGeometry, IImageVolume, RGB, VOIRange, Point3 } from '../../../types/index.js';
import type { ViewportInput } from '../../../types/IViewport.js';
import type ViewportInputOptions from '../../../types/ViewportInputOptions.js';
import type { InterpolationType } from '../../../enums/index.js';
import type { BaseViewportRenderContext, BasePresentationProps, BindingRole, DataProvider, LoadedData, MountedRendering, RenderPathResolver } from '../ViewportArchitectureTypes.js';
import type { ViewportCameraBase } from '../ViewportCameraTypes.js';
...
export type Volume3DDataPresentation = Volume3DPresentationProps & Volume3DProperties;
...
export interface Volume3DViewportRenderContext extends BaseViewportRenderContext {
    type: '3d';
    viewport: {
...
type Volume3DContextBase = Pick<Volume3DViewportRenderContext, 'display' | 'type' | 'viewport' | 'viewportId' | 'vtk'>;
...
export type Volume3DRendering = Volume3DVolumeRendering | Volume3DGeometryRendering;
export {};
