...
import { VideoEnums as VideoViewportEnum } from '../enums/index.js';
import type { DisplaySetId } from './GenericViewport/ViewportArchitectureTypes.js';
import type { VideoViewportProperties, Point3, Point2, ICamera, VideoViewportInput, VOIRange, IImage, ViewReferenceSpecifier, ViewReference, ReferenceCompatibleOptions, ImageSetOptions, IStackInput, CPUIImageData, IImageData } from '../types/index.js';
...
declare class VideoViewport extends Viewport {
    ...
    getImageDataMetadata(image: IImage | string): import("../utilities/VideoUtilities.js").VideoImageMetadata;
