...
import { MPR_CAMERA_VALUES, RENDERING_DEFAULTS, VIEWPORT_PRESETS, } from '../constants/index.js';
import { Events, MetadataModules, OrientationAxis, ViewportStatus, VOILUTFunctionType, } from '../enums/index.js';
...
import * as colormapUtils from '../utilities/colormap.js';
import invertRgbTransferFunction from '../utilities/invertRgbTransferFunction.js';
import createSigmoidRGBTransferFunction from '../utilities/createSigmoidRGBTransferFunction.js';
import transformWorldToIndex from '../utilities/transformWorldToIndex.js';
import { findMatchingColormap, updateOpacity as colormapUpdateOpacity, updateThreshold as colormapUpdateThreshold, updateOpacityMapping as colormapUpdateOpacityMapping, getOpacityState, } from '../utilities/colormap.js';
import getAcquisitionPlaneOrientation from '../utilities/getAcquisitionPlaneOrientation.js';
import { getTransferFunctionNodes, setTransferFunctionNodes, } from '../utilities/transferFunctionUtils.js';
...
import { getGenericViewportImageDisplaySet } from './GenericViewport/genericViewportDisplaySetAccess.js';
import createVolumeActor from './helpers/createVolumeActor.js';
import volumeNewImageEventDispatcher, { resetVolumeNewImageState, } from './helpers/volumeNewImageEventDispatcher.js';
...
import { actorIsA, isImageActor } from '../utilities/actorCheck.js';
import snapFocalPointToSlice from '../utilities/snapFocalPointToSlice.js';
import getVoiFromSigmoidRGBTransferFunction from '../utilities/getVoiFromSigmoidRGBTransferFunction.js';
import isEqual, { isEqualAbs, isEqualNegative } from '../utilities/isEqual.js';
import applyPreset from '../utilities/applyPreset.js';
import uuidv4 from '../utilities/uuidv4.js';
import * as metaData from '../metaData.js';
import { getCameraVectors } from './helpers/getCameraVectors.js';
import { isContextPoolRenderingEngine } from './helpers/isContextPoolRenderingEngine.js';
import mprCameraValues from '../constants/mprCameraValues.js';
import { isInvalidNumber } from './helpers/isInvalidNumber.js';
import getVolumeViewReferenceId from '../utilities/getVolumeViewReferenceId.js';
import { createSharpeningRenderPass, createSmoothingRenderPass, } from './renderPasses/index.js';
    ...
    async setDisplaySets(...entries) {
        await this.mountDisplaySets(entries, async (entry) => {
            ...
            if (!dataSet?.imageIds?.length) {
                throw new Error(`[VolumeViewport] No registered imageIds for display set ${entry.displaySetId}`);
            }
            const volumeId = resolveViewportVolumeId(dataSet.volumeId ?? entry.displaySetId);
