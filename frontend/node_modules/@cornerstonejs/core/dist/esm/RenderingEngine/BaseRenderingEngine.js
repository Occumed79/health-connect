...
import { setElementTouchActionNone, restoreElementTouchAction, } from './helpers/elementTouchAction.js';
import { getShouldUseCPURendering, getUseGenericViewport, isCornerstoneInitialized, getConfiguration, } from '../init.js';
...
import { StatsOverlay } from './helpers/stats/index.js';
import { convertColorArrayToRgbString } from '../utilities/convertColorArrayToRgbString.js';
...
class BaseRenderingEngine {
    ...
    _normalizeViewportInputEntry(viewportInputEntry) {
        ...
        return {
            ...viewportInputEntry,
            requestedType: requestedType !== type || getUseGenericViewport()
                ? requestedType
                : undefined,
            type,
    ...
    getOffscreenMultiRenderWindow(_viewportId) {
        if (!this.offscreenMultiRenderWindow) {
...
BaseRenderingEngine.NEXT_TYPE_REMAP = {
