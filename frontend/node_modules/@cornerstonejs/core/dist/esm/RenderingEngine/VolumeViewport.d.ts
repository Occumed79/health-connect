...
import type { IVolumeInput, OrientationVectors, Point3, ViewReference, ViewReferenceSpecifier } from '../types/index.js';
...
declare class VolumeViewport extends BaseVolumeViewport {
    ...
    getCurrentSlicePixelData(): import("../types/index.js").PixelDataTypedArray;
