 ...
 */
import { Color as ColorData } from './color/index.js';
...
import { Script as ScriptData } from '../mol-script/types.js';
import { Legend } from './legend.js';
import { ColorListName } from './color/lists.js';
import { Asset } from './assets.js';
import { ColorListEntry } from './color/color.js';
export declare namespace ParamDefinition {
    ...
    export function Select<T>(defaultValue: T, options: readonly SelectOption<T>[], info?: Info & {
        cycle?: boolean;
    }): Select<T>;
    ...
    export function asDataRef(ref: string): DataRef["defaultValue"];
