...
import { PluginStateObject as SO, PluginStateTransform } from '../../mol-plugin-state/objects.js';
import { Task } from '../../mol-task/index.js';
import { ParamDefinition as PD } from '../../mol-util/param-definition.js';
import { StateTransformer } from '../../mol-state/index.js';
import { computeVolumeMask, computeStructureMask, computeSoftEdge, buildMaskVolume, dilate3D } from './internal/mask-compute.js';
...
const MaskVolumeFromSource = PluginStateTransform.BuiltIn({
    ...
    to: SO.Volume.Data,
    params: {
        viewMasks: PD.Value([], { isHidden: true }),
        threshold: PD.Value(Volume.IsoValue.relative(1), { isHidden: true }),
        dilation: PD.Numeric(6, { min: 0, max: 30, step: 1 }, { description: 'Dilation radius in voxels' }),
        maskSource: PD.Value('volume', { isHidden: true }),
        atomPositions: PD.Value(undefined, { isHidden: true }),
