...
function makePointsShapeGetter(visibilityState) {
    const getShape = async (ctx, kinData, props, shape) => {
        ...
        const _shape = Shape.create('kin-points', kinData.source, _points, colorFn, // color function reads per-point colors
        () => 1, // size function
...
function makeLineShapeGetter(visibilityState) {
    const getShape = async (ctx, kinData, props, shape) => {
        ...
        const _shape = Shape.create('kin-lines', kinData.source, _lines, colorFn, // color function reads per-line colors
...
function makeMeshShapeGetter(visibilityState) {
    const getShape = async (ctx, kinData, props, shape) => {
        ...
        const _shape = Shape.create('kin-mesh', kinData.source, _mesh, colorFn, // color function reads per-triangle colors
        () => 1, // size function
        labelFn // label function
        );
        return _shape;
...
function makeSpheresShapeGetter(visibilityState) {
    const getShape = async (ctx, kinData, props, shape) => {
        ...
        const _shape = Shape.create('kin-spheres', kinData.source, _spheres, colorFn, // color function reads per-center colors
...
export function shapePointsFromKin(source, visibilityState, params, label) {
    return Task.create('Kin Shape Points Provider', async (ctx) => {
        return {
...
export function shapeLinesFromKin(source, visibilityState, params, label) {
    return Task.create('Kin Shape Lines Provider', async (ctx) => {
        return {
...
export function shapeMeshFromKin(source, visibilityState, params, label) {
    return Task.create('Kin Shape Mesh Provider', async (ctx) => {
        return {
...
export function shapeSpheresFromKin(source, visibilityState, params, label) {
    return Task.create('Kin Shape Spheres Provider', async (ctx) => {
        return {
