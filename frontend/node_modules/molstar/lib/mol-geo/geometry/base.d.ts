...
export declare const InstanceGranularityOptions: [InstanceGranularityValue, string][];
/**
 ...
 */
export declare const AutoInstanceGranularityThreshold = 50000000;
/**
 * Resolves the `instanceGranularity` param value to a boolean.
 */
export declare function resolveInstanceGranularity(value: InstanceGranularityValue, groupCount: number, instanceCount: number): boolean;
export declare namespace BaseGeometry {
    ...
    const Params: {
        ...
        emissive: PD.Numeric;
        density: PD.Numeric;
        instanceGranularity: PD.Select<InstanceGranularityValue>;
        lod: PD.Vec3;
        cellSize: PD.Numeric;
