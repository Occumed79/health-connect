...
import { createIdentityTransform } from './transform-data.js';
import { ColorNames } from '../../mol-util/color/names.js';
import { NullLocation } from '../../mol-model/location.js';
import { UniformColorTheme } from '../../mol-theme/color/uniform.js';
import { UniformSizeTheme } from '../../mol-theme/size/uniform.js';
import { smoothstep } from '../../mol-math/interpolate.js';
...
export const InstanceGranularityOptions = [[true, 'On'], [false, 'Off'], ['auto', 'Auto']];
/**
 ...
 */
export const AutoInstanceGranularityThreshold = 50000000;
/**
 * Resolves the `instanceGranularity` param value to a boolean.
 */
export function resolveInstanceGranularity(value, groupCount, instanceCount) {
    if (value === 'auto')
        return groupCount * instanceCount > AutoInstanceGranularityThreshold;
    return value;
}
//
...
(function (BaseGeometry) {
    ...
    BaseGeometry.Params = {
        ...
        instanceGranularity: PD.Select('auto', InstanceGranularityOptions, { description: 'Use instance granularity for marker, transparency, clipping, overpaint, substance data to save memory. When set to `auto`, granularity is enabled if `groupCount * instanceCount` exceeds `AutoInstanceGranularityThreshold`.' }),
