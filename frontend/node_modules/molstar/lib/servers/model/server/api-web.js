...
import { ModelServerConfig as Config, ModelServerConfig, mapSourceAndIdToFilename } from '../config.js';
import { ConsoleLogger } from '../../../mol-util/console-logger.js';
import { resolveJob } from './query.js';
import { JobManager, JobEntry } from './jobs.js';
import { normalizeRestQueryParams, normalizeRestCommonParams, QueryList } from './api.js';
import { getApiSchema, shortcutIconLink } from './api-schema.js';
import { swaggerUiAssetsHandler, swaggerUiIndexHandler } from '../../common/swagger-ui/index.js';
import { getMultiQuerySpecFilename } from './api-web-multiple.js';
import { SimpleResponseResultWriter, TarballResponseResultWriter } from '../utils/writer.js';
import { splitCamelCase } from '../../../mol-util/string.js';
import { healthCheck } from '../../common/util.js';
function makePath(p) {
