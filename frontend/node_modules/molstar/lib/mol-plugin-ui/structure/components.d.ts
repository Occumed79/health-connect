...
import { CollapsableControls, CollapsableState, PurePluginUIComponent } from '../base.js';
...
export declare class AddComponentControls extends PurePluginUIComponent<AddComponentControlsProps, AddComponentControlsState> {
    ...
    get selectedStructures(): readonly import("../../mol-plugin-state/manager/structure/hierarchy-state.js").StructureRef[];
    get currentStructures(): import("../../mol-plugin-state/manager/structure/hierarchy-state.js").StructureRef[];
    apply: () => void;
