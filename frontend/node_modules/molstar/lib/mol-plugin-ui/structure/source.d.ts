 ...
 */
import { TrajectoryRef } from '../../mol-plugin-state/manager/structure/hierarchy-state.js';
...
export declare class StructureSourceControls extends CollapsableControls<{}, StructureSourceControlState> {
    ...
    get modelIndex(): import("react").JSX.Element | null;
    updateStructure: (params: any) => Promise<void>;
    get structureType(): import("react").JSX.Element | null;
    get transform(): import("react").JSX.Element | null | undefined;
    renderControls(): import("react").JSX.Element;
}
export {};
