...
import { FocusLoci } from '../../mol-plugin/behavior/dynamic/representation.js';
import { lociLabel } from '../../mol-theme/label.js';
...
import { CancelOutlinedSvg, CenterFocusStrongSvg } from '../controls/icons.js';
...
export class StructureFocusControls extends PluginUIComponent {
    constructor() {
        super(...arguments);
    ...
    getToggleBindingLabel() {
        var _a;
        const t = this.plugin.state.behaviors.transforms.get(FocusLoci.id);
        if (!t)
            return '';
