...
export declare class SelectionInfo extends PluginUIComponent<{}, {
    ...
    get selection(): React.JSX.Element;
...
export declare function MesoViewportSnapshotDescription(): React.JSX.Element | null;
...
export declare class EntityControls extends PluginUIComponent<{}, {
    ...
    renderGraphics(): React.JSX.Element;
    render(): React.JSX.Element;
}
