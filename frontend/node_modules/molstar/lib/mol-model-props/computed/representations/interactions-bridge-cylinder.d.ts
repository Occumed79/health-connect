...
export declare const BridgeParams: {
    ...
    emissive: PD.Numeric;
    density: PD.Numeric;
    instanceGranularity: PD.Select<import("../../../mol-geo/geometry/base.js").InstanceGranularityValue>;
    lod: PD.Vec3;
    cellSize: PD.Numeric;
    batchSize: PD.Numeric;
};
export type BridgeParams = typeof BridgeParams;
export declare function BridgeVisual(materialId: number): ComplexVisual<BridgeParams>;
