...
declare const RawData: StateTransformer<SO.Root, SO.Data.String | SO.Data.Binary, PD.Normalize<{
    data: string | ArrayBuffer | Uint8Array<ArrayBuffer> | number[];
    label: string | undefined;
}>>;
...
declare const ParsePly: StateTransformer<SO.Data.String | SO.Data.Binary, SO.Format.Ply, PD.Normalize<{}>>;
type ParseObj = typeof ParseObj;
declare const ParseObj: StateTransformer<SO.Data.String, SO.Format.Obj, PD.Normalize<{}>>;
type ParseVtp = typeof ParseVtp;
declare const ParseVtp: StateTransformer<SO.Data.Binary, SO.Format.Vtp, PD.Normalize<{}>>;
...
declare const ParseMtz: StateTransformer<SO.Data.Binary, SO.Format.Mtz, PD.Normalize<{}>>;
