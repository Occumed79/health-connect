...
import { volumeFromStructureFactors } from '../../mol-model-formats/volume/structure-factors.js';
import { volumeFromMtz } from '../../mol-model-formats/volume/mtz.js';
...
const VolumeFromStructureFactorsCif = PluginStateTransform.BuiltIn({
    ...
    params(a) {
        ...
        return {
            ...
            entryId: PD.Text(''),
            mapType: PD.Select('2fo-fc', [['2fo-fc', '2Fo-Fc (pdbx_FWT/PHWT)'], ['fo-fc', 'Fo-Fc (pdbx_DELFWT/DELPHWT)']]),
        };
    }
})({
    isApplicable: a => a.data.blocks.length > 0,
