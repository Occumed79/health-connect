...
import { ChainIdColorThemeProvider } from '../../../mol-theme/color/chain-id.js';
import { OperatorNameColorThemeProvider } from '../../../mol-theme/color/operator-name.js';
...
const MesoscaleGraphicsOptions = PD.arrayToOptions(Object.keys(Spheres.LodLevelsPresets));
...
const mesoscale = StructureRepresentationPresetProvider({
    ...
    params: () => ({
        ...CommonParams,
        graphics: PD.Select('quality', MesoscaleGraphicsOptions),
    }),
    async apply(ref, params, plugin) {
        var _a, _b, _c, _d, _e, _f;
        const structureCell = StateObjectRef.resolveAndCheck(plugin.state.data, ref);
