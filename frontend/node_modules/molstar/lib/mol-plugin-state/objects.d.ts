...
import { MtzFile } from '../mol-io/reader/mtz/schema.js';
...
import { ObjFile } from '../mol-io/reader/obj/schema.js';
import { VtpFile } from '../mol-io/reader/vtp/schema.js';
...
export declare namespace PluginStateObject {
    ...
    export namespace Format {
        ...
        const Obj_base: {
            ...
            type: TypeInfo;
            is(obj?: StateObject): obj is StateObject<ObjFile, TypeInfo>;
        };
        export class Obj extends Obj_base {
        }
        const Vtp_base: {
            new (data: VtpFile, props?: {
                label: string;
                description?: string;
            } | undefined): {
                id: import("../mol-util/index.js").UUID;
            ...
            type: TypeInfo;
            is(obj?: StateObject): obj is StateObject<VtpFile, TypeInfo>;
        };
        export class Vtp extends Vtp_base {
        }
        const Ccp4_base: {
        ...
        const Mtz_base: {
            ...
            type: TypeInfo;
            is(obj?: StateObject): obj is StateObject<MtzFile, TypeInfo>;
        };
        export class Mtz extends Mtz_base {
        }
        export type BlobEntry = {
            id: string;
        } & ({
...
export declare namespace PluginStateTransform {
    const CreateBuiltIn: <A extends StateObject, B extends StateObject, P extends {} = {}>(definition: StateTransformer.Definition<A, B, P>) => StateTransformer<any, any, any>;
