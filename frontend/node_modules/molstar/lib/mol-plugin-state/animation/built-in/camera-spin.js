...
export const AnimateCameraSpin = PluginStateAnimation.create({
    ...
    async apply(animState, t, ctx) {
        ...
        const a = (_b = ctx.params.axis) !== null && _b !== void 0 ? _b : Vec3.create(0, -1, 0); // default for backwards compatibility
        Vec3.set(_axis, a[0] * _side[0] + a[1] * _up[0] + a[2] * _axis[0], a[0] * _side[1] + a[1] * _up[1] + a[2] * _axis[1], a[0] * _side[2] + a[1] * _up[2] + a[2] * _axis[2]);
