 ...
 */
import { Coordinates, Time } from '../../mol-model/structure/coordinates.js';
import { lammpsUnitStyles } from '../../mol-io/reader/lammps/schema.js';
 ...
 */
export function getCanonicalOrder(frame) {
...
async function getModels(mol, ctx, unitsStyle = 'real') {
    ...
    if (mol.bounds.length > 0) {
        ...
        const symmetry = ModelSymmetry.fromCell(Vec3.create(lx * scale, ly * scale, lz * scale), Vec3.create(Math.PI / 2, Math.PI / 2, Math.PI / 2));
