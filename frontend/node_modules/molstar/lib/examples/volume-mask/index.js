...
import { VolumeMaskBehavior } from '../../extensions/volume-mask/index.js';
import { VolumeMaskController } from './controller.js';
import { MaskCreatorPanel } from './ui/mask-panel.js';
...
async function init() {
    ...
    ReactDOM.render(React.createElement(MaskCreatorPanel, { plugin, controller }), document.getElementById('mask-panel'));
