 ...
 */
import { Structure, Model } from '../mol-model/structure.js';
import { PluginFeatureDetection } from './features.js';
...
export const PluginConfig = {
    ...
    Viewport: {
        ...
        ShowXR: item('viewer.show-xr', 'always'),
    },
    Download: {
    ...
    Structure: {
        ...
        DefaultRepresentationPreset: item('structure.default-representation-preset', 'preset-structure-representation-auto'),
