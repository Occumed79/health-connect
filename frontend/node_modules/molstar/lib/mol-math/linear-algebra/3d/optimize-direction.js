...
function eachPosition(points, callback) {
 ...
 * the camera.
 */
export function leastObstructedDirection(points, options = {}) {
    var _a;
    const origin = options.origin;
    const minDistance = (_a = options.minDistance) !== null && _a !== void 0 ? _a : 1e-6;
    ...
    const dir = Vec3.create(Matrix.get(M, 0, 0), Matrix.get(M, 1, 0), Matrix.get(M, 2, 0));
