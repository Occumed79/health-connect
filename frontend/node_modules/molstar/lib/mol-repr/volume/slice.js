...
function getSampledImage(volume, theme, info, isoValue, trim, image) {
    ...
    im.setBoundingSphere(Volume.isPeriodic(volume) ? Volume.getBoundingSphere(volume, Interval.ofLength(volume.instances.length)) : Grid.getBoundingSphere(volume.grid));
