...
import { CameraTransitionManager, CameraTransitionOptions } from './camera/transition.js';
...
export declare class Camera implements ICamera {
    ...
    private newPosition;
    update(): boolean;
    setState(snapshot: Partial<Camera.Snapshot>, durationMs?: number, options?: CameraTransitionOptions): void;
    ...
    setRotation(rotation: Euler, durationMs?: number): void;
    ...
    setTranslation(translation: Vec3, durationMs?: number): void;
