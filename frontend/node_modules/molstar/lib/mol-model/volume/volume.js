...
(function (Volume) {
    ...
    function getBoundingSphere(volume, instances, boundingSphere) {
        ...
        if (OrderedSet.isEmpty(instances))
    ...
    (function (Isosurface) {
        ...
        function getBoundingSphere(volume, isoValue, instances, boundingSphere) {
            ...
            if (OrderedSet.isEmpty(instances))
                return Sphere3D.copy(boundingSphere || Sphere3D(), gs);
            const spheres = [];
            for (let i = 0, il = OrderedSet.size(instances); i < il; ++i) {
    ...
    (function (Segment) {
        ...
        function getBoundingSphere(volume, elements, boundingSphere) {
            ...
            if (segmentation) {
                ...
                return Volume.getBoundingSphere(volume, Interval.ofLength(volume.instances.length), boundingSphere);
            }
        }
