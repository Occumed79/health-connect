...
import { Histogram, HistogramRobustStats } from '../../mol-math/histogram.js';
...
declare namespace Grid {
    ...
    export function getIsosurfaceBoundingSphere(grid: Grid, isoValue: number, boundingSphere?: Sphere3D): Sphere3D;
    /**
     ...
     * Cached on the Grid object.
     */
    export function getRobustStats(grid: Grid, opts?: {
        ignoreZero?: boolean;
        binCount?: number;
     ...
     */
    export function trilinearlyInterpolate(gridCoords: Vec3, mi: number, mj: number, mk: number, isPeriodic: boolean, getValue: (i: number, j: number, k: number) => number): number;
    /**
