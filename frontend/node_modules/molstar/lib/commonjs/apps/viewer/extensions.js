...
const behavior_5 = require("../../extensions/kinemage/behavior.js");
const interactivity = tslib_1.__importStar(require("../../extensions/plugin/interactivity.js"));
...
exports.ExtensionMap = {
    ...
    'kinemage': spec_1.PluginSpec.Behavior(behavior_5.KinemageExtension),
...
exports.PluginExtensions = {
    ...
    plugin: {
        ...
        loaders,
        models: {
            PluginViewModel: view_model_1.PluginViewModel,
            PluginUIViewModel: ui_view_model_1.PluginUIViewModel,
        },
    },
};
