...
import * as interactivity from '../../extensions/plugin/interactivity.js';
import * as loaders from '../../extensions/plugin/loaders.js';
import { PluginViewModel } from '../../extensions/plugin/view-model.js';
import { PluginUIViewModel } from '../../extensions/plugin/ui-view-model.js';
...
export declare const PluginExtensions: {
    ...
    plugin: {
        ...
        models: {
            PluginViewModel: typeof PluginViewModel;
            PluginUIViewModel: typeof PluginUIViewModel;
        };
    };
};
