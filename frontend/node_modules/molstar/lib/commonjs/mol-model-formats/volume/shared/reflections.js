...
exports.computeElectronDensityFromReflections = computeElectronDensityFromReflections;
const fft_1 = require("../../../mol-math/fourier-transform/fft.js");
/**
 ...
 */
async function computeElectronDensityFromReflections(h, k, l, amp, phi, sg, ctx) {
    ...
    for (let i = 0; i < count; i++) {
        ...
        if (!isFinite(aVal) || !isFinite(phiDeg))
            continue;
    ...
    const N0 = (0, fft_1.nextPow2)(2 * maxH + 2);
    const N1 = (0, fft_1.nextPow2)(2 * maxK + 2);
    const N2 = (0, fft_1.nextPow2)(2 * maxL + 2);
     ...
     */
    const setRefl = (rh, rk, rl, rAmp, phiDeg) => {
        let hi = ((rh % N0) + N0) % N0;
        let ki = ((rk % N1) + N1) % N1;
        let li = ((rl % N2) + N2) % N2;
    ...
    (0, fft_1.fft3dHermitian)(gridRe, gridIm, N0, N1, N2, density);
