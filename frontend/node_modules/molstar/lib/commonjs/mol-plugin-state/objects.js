...
(function (PluginStateObject) {
    ...
    (function (Format) {
        ...
        Format.Ply = Ply;
        class Obj extends PluginStateObject.Create({ name: 'OBJ File', typeClass: 'Data' }) {
        }
        Format.Obj = Obj;
        class Vtp extends PluginStateObject.Create({ name: 'VTP File', typeClass: 'Data' }) {
        }
        Format.Vtp = Vtp;
        ...
        Format.Dx = Dx;
        class Mtz extends PluginStateObject.Create({ name: 'MTZ File', typeClass: 'Data' }) {
        }
        Format.Mtz = Mtz;
