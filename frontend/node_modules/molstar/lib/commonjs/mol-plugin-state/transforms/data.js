...
exports.LazyVolume = exports.ParseJson = exports.ImportJson = exports.ImportString = exports.ParseDx = exports.ParseMtz = exports.ParseDsn6 = exports.ParseCcp4 = exports.ParseVtp = exports.ParseObj = exports.ParsePly = exports.ParseTop = exports.ParsePrmtop = exports.ParsePsf = exports.ParseCube = exports.ParseCif = exports.ParseBlob = exports.ReadFile = exports.RawData = exports.DeflateData = exports.DownloadBlob = exports.Download = void 0;
const tslib_1 = require("tslib");
const CCP4 = tslib_1.__importStar(require("../../mol-io/reader/ccp4/parser.js"));
const cif_1 = require("../../mol-io/reader/cif.js");
const DSN6 = tslib_1.__importStar(require("../../mol-io/reader/dsn6/parser.js"));
const PLY = tslib_1.__importStar(require("../../mol-io/reader/ply/parser.js"));
const OBJ = tslib_1.__importStar(require("../../mol-io/reader/obj/parser.js"));
const VTP = tslib_1.__importStar(require("../../mol-io/reader/vtp/parser.js"));
const parser_1 = require("../../mol-io/reader/psf/parser.js");
const parser_2 = require("../../mol-io/reader/mtz/parser.js");
...
const parser_3 = require("../../mol-io/reader/cube/parser.js");
const parser_4 = require("../../mol-io/reader/dx/parser.js");
const names_1 = require("../../mol-util/color/names.js");
const type_helpers_1 = require("../../mol-util/type-helpers.js");
const parser_5 = require("../../mol-io/reader/prmtop/parser.js");
const parser_6 = require("../../mol-io/reader/top/parser.js");
...
const ParseCube = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply({ a }) {
        return mol_task_1.Task.create('Parse Cube', async (ctx) => {
            const parsed = await (0, parser_3.parseCube)(a.data, a.label).runInContext(ctx);
            if (parsed.isError)
                throw new Error(parsed.message);
...
const ParsePrmtop = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply({ a }) {
        return mol_task_1.Task.create('Parse PRMTOP', async (ctx) => {
            const parsed = await (0, parser_5.parsePrmtop)(a.data).runInContext(ctx);
            if (parsed.isError)
                throw new Error(parsed.message);
...
const ParseTop = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply({ a }) {
        return mol_task_1.Task.create('Parse TOP', async (ctx) => {
            const parsed = await (0, parser_6.parseTop)(a.data).runInContext(ctx);
            if (parsed.isError)
                throw new Error(parsed.message);
...
const ParseObj = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-obj',
    display: { name: 'Parse OBJ', description: 'Parse OBJ from String data' },
    from: [objects_1.PluginStateObject.Data.String],
    to: objects_1.PluginStateObject.Format.Obj
})({
    apply({ a }) {
        return mol_task_1.Task.create('Parse OBJ', async (ctx) => {
            ...
            if (parsed.isError)
                throw new Error(parsed.message);
            return new objects_1.PluginStateObject.Format.Obj(parsed.result, { label: 'OBJ Data' });
        });
    }
});
exports.ParseObj = ParseObj;
const ParseVtp = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-vtp',
    display: { name: 'Parse VTP', description: 'Parse VTP (VTK PolyData) from Binary data' },
    from: [objects_1.PluginStateObject.Data.Binary],
    to: objects_1.PluginStateObject.Format.Vtp
})({
    apply({ a }) {
        return mol_task_1.Task.create('Parse VTP', async (ctx) => {
            const parsed = await VTP.parseVtp(a.data).runInContext(ctx);
            if (parsed.isError)
                throw new Error(parsed.message);
            return new objects_1.PluginStateObject.Format.Vtp(parsed.result, { label: 'VTP Data' });
        });
    }
});
...
const ParseMtz = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-mtz',
    display: { name: 'Parse MTZ', description: 'Parse CCP4 MTZ reflection file from Binary data' },
    from: [objects_1.PluginStateObject.Data.Binary],
    to: objects_1.PluginStateObject.Format.Mtz
})({
    apply({ a }) {
        return mol_task_1.Task.create('Parse MTZ', async (ctx) => {
            const parsed = await (0, parser_2.parseMtz)(a.data, a.label).runInContext(ctx);
            if (parsed.isError)
                throw new Error(parsed.message);
            return new objects_1.PluginStateObject.Format.Mtz(parsed.result);
        });
    }
});
exports.ParseMtz = ParseMtz;
const ParseDx = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply({ a }) {
        return mol_task_1.Task.create('Parse DX', async (ctx) => {
            const parsed = await (0, parser_4.parseDx)(a.data, a.label).runInContext(ctx);
            if (parsed.isError)
                throw new Error(parsed.message);
