...
import { StructureFactorMapType } from '../../mol-model-formats/volume/structure-factors.js';
...
declare const VolumeFromStructureFactorsCif: StateTransformer<SO.Format.Cif, SO.Volume.Data, PD.Normalize<{
    blockHeader: string | undefined;
    entryId: string;
    mapType: StructureFactorMapType;
}>>;
type VolumeFromMtz = typeof VolumeFromMtz;
declare const VolumeFromMtz: StateTransformer<SO.Format.Mtz, SO.Volume.Data, PD.Normalize<{
    ampLabel: string;
    phiLabel: string;
    entryId: string;
}>>;
...
declare const VolumeInstances: StateTransformer<SO.Volume.Data, SO.Volume.Data, PD.Normalize<{
    mode: "transforms" | "periodicRange";
    transforms: PD.Normalize<{
        transform: /*elided*/ any;
    }>[];
    periodicRange: PD.Normalize<{
        min: /*elided*/ any;
        max: /*elided*/ any;
    }>;
}>>;
