...
const chain_id_1 = require("../../../mol-theme/color/chain-id.js");
const operator_name_1 = require("../../../mol-theme/color/operator-name.js");
...
const MesoscaleGraphicsOptions = param_definition_1.ParamDefinition.arrayToOptions(Object.keys(spheres_1.Spheres.LodLevelsPresets));
function getMesoscaleLodLevels(mode) {
    return spheres_1.Spheres.LodLevelsPresets[mode];
}
const mesoscale = StructureRepresentationPresetProvider({
    ...
    params: () => ({
        ...CommonParams,
        graphics: param_definition_1.ParamDefinition.Select('quality', MesoscaleGraphicsOptions),
    }),
    async apply(ref, params, plugin) {
        var _a, _b, _c, _d, _e, _f;
        const structureCell = mol_state_1.StateObjectRef.resolveAndCheck(plugin.state.data, ref);
        ...
        const structure = structureCell.obj.data;
        const { update, builder, typeParams, color } = reprBuilder(plugin, params, structure);
        const graphics = (_a = params.graphics) !== null && _a !== void 0 ? _a : 'quality';
        ...
        await update.commit({ revertOnError: true });
        await updateFocusRepr(plugin, structure, (_d = (_c = (_b = params.theme) === null || _b === void 0 ? void 0 : _b.focus) === null || _c === void 0 ? void 0 : _c.name) !== null && _d !== void 0 ? _d : color, (_f = (_e = params.theme) === null || _e === void 0 ? void 0 : _e.focus) === null || _f === void 0 ? void 0 : _f.params);
        return { components, representations };
    }
});
