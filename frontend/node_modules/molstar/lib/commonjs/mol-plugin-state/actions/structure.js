...
const representation_preset_1 = require("../builder/structure/representation-preset.js");
const trajectory_1 = require("../formats/trajectory.js");
...
const model_1 = require("../transforms/model.js");
...
const topology_1 = require("../formats/topology.js");
const coordinates_1 = require("../formats/coordinates.js");
        ...
        return {
            source: param_definition_1.ParamDefinition.MappedStatic('pdb', {
                ...
                'alphafolddb': param_definition_1.ParamDefinition.Group({
                    provider: param_definition_1.ParamDefinition.Group({
                        id: param_definition_1.ParamDefinition.Text('Q8W3K0', {
                            label: 'ID(s)',
