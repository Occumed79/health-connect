...
const lru_cache_1 = require("../../../../mol-util/lru-cache.js");
const url_1 = require("../../../../mol-util/url.js");
...
const global_transform_1 = require("../../../../mol-model/structure/model/properties/global-transform.js");
...
(function (VolumeStreaming) {
    ...
    class Behavior extends behavior_1.PluginBehavior.WithSubscribers {
        ...
        getBoxFromLoci(loci) {
            ...
            const box = structure_1.StructureElement.Loci.getBoundary(extendedLoci).box;
            if (transform && !Number.isNaN(this._invTransform[0])) {
                geometry_1.Box3D.transform(box, box, this._invTransform);
            }
