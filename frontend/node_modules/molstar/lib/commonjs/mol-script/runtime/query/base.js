...
exports.QuerySymbolRuntime = exports.QueryRuntimeArguments = exports.CompiledQueryFn = exports.QueryCompiledSymbol = exports.QueryCompilerCtx = exports.DefaultQueryRuntimeTable = exports.QueryRuntimeTable = void 0;
exports.compile = compile;
const expression_1 = require("../../language/expression.js");
...
class QueryRuntimeTable {
    ...
    addCustomProp(desc) {
        if (this.addedProps.has(desc.name))
            return;
