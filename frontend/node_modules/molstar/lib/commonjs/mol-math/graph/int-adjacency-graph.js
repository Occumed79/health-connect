...
(function (IntAdjacencyGraph) {
    ...
    class UniqueEdgeBuilder {
        addEdge(i, j) {
            ...
            const id = (0, util_1.cantorPairing)(u, v);
    ...
    function connectedComponents(graph) {
        ...
        const stack = [0];
        const list = (0, int_1.LinkedIndex)(vCount);
        list.remove(0);
    ...
    IntAdjacencyGraph.graphShortestPaths = graphShortestPaths;
})(IntAdjacencyGraph || (exports.IntAdjacencyGraph = IntAdjacencyGraph = {}));
