...
const centroid_helper_1 = require("./centroid-helper.js");
const sphere3d_1 = require("../geometry/primitives/sphere3d.js");
const box3d_1 = require("./primitives/box3d.js");
...
class BoundaryHelper {
    ...
    refineExtrema() {
        ...
        for (let i = 0, il = dir98.length; i < il; ++i) {
            minDist[i] = Infinity;
            maxDist[i] = -Infinity;
            extrema[i * 2] = (0, vec3_1.Vec3)();
            extrema[i * 2 + 1] = (0, vec3_1.Vec3)();
            const di = dir98[i];
...
const getEposDir = (0, memoize_1.memoize1)((quality) => {
    let dir;
    switch (quality) {
        case '6':
            dir = [...Type001];
