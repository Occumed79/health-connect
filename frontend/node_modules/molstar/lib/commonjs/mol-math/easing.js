...
function getEasingFn(easing) {
    var _a;
    if (!easing)
        return exports.EasingFunctions.linear;
    return typeof easing === 'function' ? easing : (_a = exports.EasingFunctions[easing]) !== null && _a !== void 0 ? _a : exports.EasingFunctions.linear;
}
