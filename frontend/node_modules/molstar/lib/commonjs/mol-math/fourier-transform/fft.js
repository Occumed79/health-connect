...
exports.fft1d = fft1d;
exports.fft3d = fft3d;
exports.fft3dHermitian = fft3dHermitian;
/**
...
function getScratch(n, ref) {
    if (ref instanceof Float32Array) {
        ...
        return [_scratchRe64, _scratchIm64];
    }
}
/**
 ...
 */
function fft1d(re, im, offset, n, stride) {
 ...
 */
function transpose2dBlocked(srcRe, srcIm, dstRe, dstIm, R, C, srcOff, dstOff) {
...
function transposeAxes12(srcRe, srcIm, dstRe, dstIm, A, B, C) {
    const BC = B * C;
    for (let a = 0; a < A; a++) {
...
function transposeAxis0ToLast(srcRe, srcIm, dstRe, dstIm, N0, N1, N2) {
    transpose2dBlocked(srcRe, srcIm, dstRe, dstIm, N0, N1 * N2, 0, 0);
}
/** Shape (N1, N2, N0) → (N0, N1, N2): last axis moved to first. */
function transposeAxis0FromLast(srcRe, srcIm, dstRe, dstIm, N0, N1, N2) {
 ...
 */
function fft3dHermitian(re, im, N0, N1, N2, out) {
    ...
    const yr = (re instanceof Float32Array ? new Float32Array(N2) : new Float64Array(N2));
    const yi = (re instanceof Float32Array ? new Float32Array(N2) : new Float64Array(N2));
    let q = 0;
    for (; q + 1 < lines; q += 2) {
        const baseA = q * P;
        const baseB = (q + 1) * P;
