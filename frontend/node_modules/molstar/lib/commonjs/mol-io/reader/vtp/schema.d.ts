...
export type VtkDataType = 'Float32' | 'Float64' | 'Int8' | 'UInt8' | 'Int16' | 'UInt16' | 'Int32' | 'UInt32' | 'Int64' | 'UInt64';
/** Narrow a raw VTK `type` attribute to a VtkDataType, falling back to 'Float32' if unrecognized. */
export declare function toVtkDataType(type: string | undefined): VtkDataType;
/**
