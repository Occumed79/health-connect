...
class LineGraphControl extends React.PureComponent {
    ...
    render() {
        ...
        const presetItems = hasPresets && this.state.showPresets
            ? action_menu_1.ActionMenu.createItemsFromSelectOptions(this.props.param.getPresets())
            : null;
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.ControlRow, { label: label, control: (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', textAlignLast: 'center' }, children: [(0, jsx_runtime_1.jsx)("button", { onClick: this.toggleExpanded, disabled: this.props.isDisabled, style: { flex: '1 1 auto', overflow: 'hidden', textOverflow: 'ellipsis' }, children: `${this.state.message}` }), hasPresets && (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.BookmarksOutlinedSvg, onClick: this.toggleShowPresets, toggleState: this.state.showPresets, title: 'Presets', disabled: this.props.isDisabled, flex: true })] }) }), presetItems && (0, jsx_runtime_1.jsx)("div", { className: 'msp-control-offset', children: (0, jsx_runtime_1.jsx)(action_menu_1.ActionMenu, { items: presetItems, onSelect: this.onSelectPreset }) }), (0, jsx_runtime_1.jsx)("div", { className: 'msp-control-offset', style: { display: this.state.isExpanded ? 'block' : 'none', marginTop: 1 }, children: (0, jsx_runtime_1.jsx)(line_graph_component_1.LineGraphComponent, { data: this.props.value, volume: (_b = (_a = this.props.param).getVolume) === null || _b === void 0 ? void 0 : _b.call(_a), yAxis: this.props.param.yAxis, onChange: this.onChange, onHover: this.onHover, onDrag: this.onDrag }) })] });
    }
}
...
class ObjectListControl extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = { isExpanded: false, showPresets: false };
        this.add = (v) => {
    ...
    render() {
        ...
        const control = hasPresets
            ? (0, jsx_runtime_1.jsxs)("div", { className: 'msp-flex-row', children: [(0, jsx_runtime_1.jsx)("button", { onClick: this.toggleExpanded, disabled: this.props.isDisabled, children: value }), (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.BookmarksOutlinedSvg, onClick: this.toggleShowPresets, toggleState: this.state.showPresets, title: 'Presets', disabled: this.props.isDisabled })] })
            : (0, jsx_runtime_1.jsx)("button", { onClick: this.toggleExpanded, disabled: this.props.isDisabled, children: value });
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.ControlRow, { label: label, control: control }), hasPresets && this.state.showPresets && (0, jsx_runtime_1.jsx)(action_menu_1.ActionMenu, { items: this.presetItems(this.props.param), onSelect: this.onSelectPreset }), this.state.isExpanded && (0, jsx_runtime_1.jsxs)("div", { className: 'msp-control-offset', children: [this.props.value.map((v, i) => (0, jsx_runtime_1.jsx)(ObjectListItem, { param: this.props.param, value: v, index: i, actions: this.actions, isDisabled: this.props.isDisabled }, i)), (0, jsx_runtime_1.jsx)(common_1.ControlGroup, { header: 'New Item', children: (0, jsx_runtime_1.jsx)(ObjectListEditor, { params: this.props.param.element, apply: this.add, value: this.props.param.ctor(), isDisabled: this.props.isDisabled }) })] })] });
    }
}
