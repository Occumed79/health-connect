 ...
 */
const point_component_1 = require("./point-component.js");
...
class LineGraphComponent extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (prevProps.data !== this.props.data) {
            const points = [linear_algebra_1.Vec2.create(0, 0), linear_algebra_1.Vec2.create(1, 0)];
    ...
    get yAxisOptions() {
        var _a;
        return (_a = this.props.yAxis) !== null && _a !== void 0 ? _a : {};
    }
    get isLogY() {
    ...
    get logMin() {
        var _a;
        return (_a = this.yAxisOptions.logMin) !== null && _a !== void 0 ? _a : DefaultLogMin;
    }
    ...
    renderHistogram() {
        ...
        const fine = volume_1.Grid.getHistogram(this.props.volume.grid, volume_1.Grid.RobustStatsBinCount);
        const histogram = (0, histogram_1.downsampleHistogram)(fine, 40);
        const bars = [];
    ...
    renderAxes() {
        ...
        for (let i = 0; i < ticks.length; i++) {
            ...
            const py = this.normalizePoint(linear_algebra_1.Vec2.create(0, y))[1];
            elements.push((0, jsx_runtime_1.jsx)("text", { x: offset + 4, y: py - 4, textAnchor: "start", fontSize: "22", fill: "#888", stroke: "none", children: label }, `ticklbl${i}`));
        }
        return elements;
    }
    renderPoints() {
