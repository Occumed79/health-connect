...
export declare class ViewportControls extends PluginUIComponent<ViewportControlsProps, ViewportControlsState> {
    ...
    icon(icon: React.FC, onClick: (e: React.MouseEvent<HTMLButtonElement>) => void, title: string, isOn?: boolean, disabled?: boolean): React.JSX.Element;
    render(): React.JSX.Element;
}
export declare const Logo: () => React.JSX.Element;
export declare const Viewport: () => React.JSX.Element;
export {};
