...
import { Shape, ShapeGroup } from './shape.js';
...
import { FiniteArray } from '../mol-util/type-helpers.js';
...
declare namespace Loci {
    ...
    const Granularity: {
        ...
        structure: (loci: Loci) => StructureElement.Loci | Structure.Loci | Bond.Loci | Volume.Loci | Volume.Segment.Loci | {
            kind: "every-loci";
        } | {
            kind: "empty-loci";
