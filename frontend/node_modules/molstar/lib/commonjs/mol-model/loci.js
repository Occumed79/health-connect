...
const bonds_1 = require("./structure/structure/unit/bonds.js");
...
const structure_2 = require("./structure/structure.js");
...
const volume_1 = require("./volume/volume.js");
...
(function (Loci) {
    ...
    function getBoundingSphere(loci, boundingSphere) {
        ...
        if (loci.kind === 'structure-loci') {
            ...
            return structure_1.StructureElement.Loci.getBoundingSphere(loci, boundingSphere);
        }
            ...
            return volume_1.Volume.getBoundingSphere(loci.volume, loci.instances, boundingSphere);
        }
        else if (loci.kind === 'isosurface-loci') {
            return volume_1.Volume.Isosurface.getBoundingSphere(loci.volume, loci.isoValue, loci.instances, boundingSphere);
        }
        else if (loci.kind === 'cell-loci') {
            return volume_1.Volume.Cell.getBoundingSphere(loci.volume, loci.elements, boundingSphere);
        }
        else if (loci.kind === 'segment-loci') {
            return volume_1.Volume.Segment.getBoundingSphere(loci.volume, loci.elements, boundingSphere);
        }
    }
            ...
            return structure_1.StructureElement.Loci.is(loci)
                ...
                : shape_1.ShapeGroup.isLoci(loci)
                    ...
                    : volume_1.Volume.Cell.isLoci(loci)
                        ? volume_1.Volume.Loci(loci.volume, int_1.Interval.ofLength(loci.volume.instances.length))
                        : volume_1.Volume.Isosurface.isLoci(loci)
                            ? volume_1.Volume.Loci(loci.volume, int_1.Interval.ofLength(loci.volume.instances.length))
                            : loci;
        },
