...
const principal_axes_1 = require("../../../../mol-math/linear-algebra/matrix/principal-axes.js");
const properties_1 = require("../properties.js");
const boundary_helper_1 = require("../../../../mol-math/geometry/boundary-helper.js");
const tuple_1 = require("../../../../mol-data/int/tuple.js");
...
(function (Loci) {
    ...
    function extendToRadius(loci, radius) {
        ...
        forEachLocation(loci, loc => {
            ...
            for (let i = 0, il = result.count; i < il; ++i) {
                ...
                let set = elementsByUnit.get(unit.id);
                if (!set) {
                    set = new Set();
     ...
     */
    function getWholeUnitBoundarySphere(unit) {
        const { isIdentity, matrix } = unit.conformation.operator;
        const { sphere } = unit.boundary;
        return isIdentity ? sphere : geometry_1.Sphere3D.transform(tempSphereBoundary, sphere, matrix);
    }
    function getBoundingSphere(loci, boundingSphere) {
        ...
        if (isWholeStructure(loci)) {
            return geometry_1.Sphere3D.copy(boundingSphere || (0, geometry_1.Sphere3D)(), loci.structure.boundary.sphere);
        }
    ...
    function getBoundary(loci, boundary) {
        const sphere = getBoundingSphere(loci, boundary === null || boundary === void 0 ? void 0 : boundary.sphere);
        const box = geometry_1.Box3D.fromSphere3D((boundary === null || boundary === void 0 ? void 0 : boundary.box) || (0, geometry_1.Box3D)(), sphere);
        return { sphere, box };
    }
