...
const builders_1 = require("../utils/builders.js");
const unique_subset_builder_1 = require("../../structure/util/unique-subset-builder.js");
const structure_set_1 = require("../utils/structure-set.js");
const generic_1 = require("../../../../mol-data/generic.js");
const element_1 = require("../../structure/element.js");
const residue_set_1 = require("../../model/properties/utils/residue-set.js");
    ...
    return function query_surroundingLigands(ctx) {
        ...
        for (const unit of ctx.inputStructure.units) {
            ...
            while (chainsIt.hasNext) {
                ...
                if (properties_1.StructureProperties.entity.type(l) === 'water')
                    continue;
                residuesIt.setSegment(chainSegment);
                while (residuesIt.hasNext) {
                    const residueSegment = residuesIt.move();
