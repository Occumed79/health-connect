...
function createMarkers(count, type, markerData) {
    if (markerData) {
        const markers = (0, util_1.createTextureImage)(Math.max(1, count), 1, Uint8Array, markerData.tMarker.ref.value.array);
        ...
        const markers = (0, util_1.createTextureImage)(Math.max(1, count), 1, Uint8Array);
        return {
