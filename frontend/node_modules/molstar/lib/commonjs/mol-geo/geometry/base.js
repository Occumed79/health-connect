...
exports.BaseGeometry = exports.AutoInstanceGranularityThreshold = exports.InstanceGranularityOptions = exports.ColorSmoothingParams = exports.VisualQualityOptions = exports.VisualQualityNames = exports.VisualQualityInfo = void 0;
exports.hasColorSmoothingProp = hasColorSmoothingProp;
exports.getColorSmoothingProps = getColorSmoothingProps;
exports.resolveInstanceGranularity = resolveInstanceGranularity;
const mol_util_1 = require("../../mol-util/index.js");
const location_iterator_1 = require("../util/location-iterator.js");
const param_definition_1 = require("../../mol-util/param-definition.js");
const transform_data_1 = require("./transform-data.js");
const names_1 = require("../../mol-util/color/names.js");
const location_1 = require("../../mol-model/location.js");
const uniform_1 = require("../../mol-theme/color/uniform.js");
const uniform_2 = require("../../mol-theme/size/uniform.js");
...
exports.InstanceGranularityOptions = [[true, 'On'], [false, 'Off'], ['auto', 'Auto']];
/**
 ...
 */
exports.AutoInstanceGranularityThreshold = 50000000;
/**
 * Resolves the `instanceGranularity` param value to a boolean.
 */
function resolveInstanceGranularity(value, groupCount, instanceCount) {
    if (value === 'auto')
        return groupCount * instanceCount > exports.AutoInstanceGranularityThreshold;
    return value;
}
//
var BaseGeometry;
(function (BaseGeometry) {
    ...
    BaseGeometry.Params = {
        ...
        instanceGranularity: param_definition_1.ParamDefinition.Select('auto', exports.InstanceGranularityOptions, { description: 'Use instance granularity for marker, transparency, clipping, overpaint, substance data to save memory. When set to `auto`, granularity is enabled if `groupCount * instanceCount` exceeds `AutoInstanceGranularityThreshold`.' }),
    ...
    function createValues(props, counts) {
        ...
        return {
            ...
            instanceGranularity: mol_util_1.ValueCell.create(resolveInstanceGranularity(props.instanceGranularity, counts.groupCount, counts.instanceCount)),
    ...
    function updateValues(values, props) {
        ...
        mol_util_1.ValueCell.updateIfChanged(values.instanceGranularity, resolveInstanceGranularity(props.instanceGranularity, values.uGroupCount.ref.value, values.instanceCount.ref.value));
