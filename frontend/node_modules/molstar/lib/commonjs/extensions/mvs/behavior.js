...
exports.MolViewSpecBehavior = exports.MolViewSpec = void 0;
...
const file_1 = require("../../mol-util/file.js");
...
const formats_1 = require("./components/formats.js");
    ...
    ctor: class extends behavior_1.PluginBehavior.Handler {
        ...
        register() {
            ...
            this.ctx.state.data.registerRefResolver('mvs', (state, ref) => {
                const tagSearch = mol_state_1.StateTree.doPreOrder(state.tree, state.tree.root, { ref, ret: undefined }, (n, _, s) => {
                    var _a, _b;
                    if (!n.tags)
                        return;
            ...
            this.ctx.managers.markdownExtensions.registerRefResolver('mvs', (plugin, refs) => {
                ...
                return mol_state_1.StateTree.doPreOrder(plugin.state.data.tree, plugin.state.data.tree.root, { mvsRefs, plugin, cells: [] }, (n, _, s) => {
                    if (!n.tags)
                        return;
            ...
            this.ctx.managers.markdownExtensions.registerUriResolver('mvs', (plugin, uri) => {
                ...
                try {
                    return (0, file_1.fileToDataUri)(asset.file);
                }
                catch (e) {
...
exports.MolViewSpecBehavior = spec_1.PluginSpec.Behavior(exports.MolViewSpec);
