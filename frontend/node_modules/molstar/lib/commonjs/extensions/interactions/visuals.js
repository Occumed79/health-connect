...
exports.InteractionVisualParams = {
    ...
    styles: param_definition_1.ParamDefinition.Group({
        ...
        'water-bridge': visualParams({ color: (0, color_1.Color)(0x00CCEE), style: 'dashed' }),
...
function buildInteractionsShape(interactions, params, prev) {
    ...
    const sA = (0, geometry_1.Sphere3D)();
    const sB = (0, geometry_1.Sphere3D)();
    ...
    for (const interaction of interactions.elements) {
        ...
        structure_1.StructureElement.Loci.getBoundingSphere(interaction.a, sA);
        structure_1.StructureElement.Loci.getBoundingSphere(interaction.b, sB);
        linear_algebra_1.Vec3.sub(dir, sB.center, sA.center);
        linear_algebra_1.Vec3.normalize(dir, dir);
        linear_algebra_1.Vec3.copy(pA, sA.center);
        linear_algebra_1.Vec3.copy(pB, sB.center);
