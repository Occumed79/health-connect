 ...
 */
import { CollapsableState, CollapsableControls } from '../../mol-plugin-ui/base.js';
import { AssemblySymmetryProps } from './prop.js';
...
export declare class AssemblySymmetryControls extends CollapsableControls<{}, AssemblySymmetryControlState> {
    ...
    canEnable(): boolean;
    renderEnable(): import("react").JSX.Element | null;
    renderNoSymmetries(): import("react").JSX.Element;
    get params(): {
    ...
    renderParams(): import("react").JSX.Element;
    renderControls(): import("react").JSX.Element | null;
}
export {};
