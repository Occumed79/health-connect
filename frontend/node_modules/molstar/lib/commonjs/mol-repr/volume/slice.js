...
function getSampledImage(volume, theme, info, isoValue, trim, image) {
    ...
    im.setBoundingSphere(volume_1.Volume.isPeriodic(volume) ? volume_1.Volume.getBoundingSphere(volume, interval_1.Interval.ofLength(volume.instances.length)) : volume_1.Grid.getBoundingSphere(volume.grid));
