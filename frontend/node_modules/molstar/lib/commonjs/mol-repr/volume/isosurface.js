...
async function createVolumeIsosurfaceMesh(ctx, volume, key, theme, props, mesh) {
    ...
    surface.setBoundingSphere(volume_1.Grid.getIsosurfaceBoundingSphere(volume.grid, volume_1.Volume.IsoValue.toAbsolute(props.isoValue, volume.grid.stats).absoluteValue));
    return surface;
}
...
async function createVolumeIsosurfaceWireframe(ctx, volume, key, theme, props, lines) {
    ...
    wireframe.setBoundingSphere(volume_1.Grid.getIsosurfaceBoundingSphere(volume.grid, volume_1.Volume.IsoValue.toAbsolute(props.isoValue, volume.grid.stats).absoluteValue));
    return wireframe;
}
