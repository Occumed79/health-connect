...
function ShapeRepresentation(getShape, geometryUtils, builder = {}) {
    ...
    function lociApply(loci, apply) {
        const instanceGranularity = (0, base_1.resolveInstanceGranularity)(currentProps.instanceGranularity, _shape.groupCount, _shape.transforms.length);
    ...
    return {
        ...
        getLoci(pickingId) {
            ...
            if (_renderObject && _renderObject.id === objectId) {
                const instanceGranularity = (0, base_1.resolveInstanceGranularity)(currentProps.instanceGranularity, _shape.groupCount, _shape.transforms.length);
                if (groupId === picking_1.PickingId.Null || instanceGranularity) {
