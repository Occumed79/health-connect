...
function UnitsVisual(builder, materialId) {
    ...
    function update(newGeometry) {
        if (updateState.createNew) {
            ...
            if (updateState.updateTransform) {
                ...
                if ((0, base_1.resolveInstanceGranularity)(newProps.instanceGranularity, groupCount, instanceCount)) {
    ...
    function lociApply(loci, apply, isMarking) {
        const instanceGranularity = (0, base_1.resolveInstanceGranularity)(currentProps.instanceGranularity, locationIt.groupCount, locationIt.instanceCount);
    ...
    return {
        ...
        getLoci(pickingId) {
            ...
            if ((0, base_1.resolveInstanceGranularity)(currentProps.instanceGranularity, locationIt.groupCount, locationIt.instanceCount)) {
                pickingId = { ...pickingId, groupId: picking_1.PickingId.Null };
            }
