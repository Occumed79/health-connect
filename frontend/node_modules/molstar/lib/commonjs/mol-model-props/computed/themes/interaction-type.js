...
const common_1 = require("../interactions/common.js");
...
function typeColor(type) {
    switch (type) {
        ...
        case common_1.InteractionType.WaterBridge:
...
function InteractionTypeColorTheme(ctx, props) {
    ...
    if (interactions && interactions.value) {
        color = (location) => {
            ...
            if (interactions_2.Bridges.isLocation(location)) {
