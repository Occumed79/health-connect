...
const interactions_intra_unit_cylinder_1 = require("./interactions-intra-unit-cylinder.js");
const interactions_1 = require("../interactions.js");
const interactions_inter_unit_cylinder_1 = require("./interactions-inter-unit-cylinder.js");
const interactions_bridge_cylinder_1 = require("./interactions-bridge-cylinder.js");
const params_1 = require("../../../mol-repr/structure/params.js");
const InteractionsVisuals = {
    ...
    'bridge': (ctx, getParams) => (0, representation_2.ComplexRepresentation)('Bridge cylinder', ctx, getParams, interactions_bridge_cylinder_1.BridgeVisual),
};
exports.InteractionsParams = {
    ...
    ...interactions_bridge_cylinder_1.BridgeParams,
    ...
    visuals: param_definition_1.ParamDefinition.MultiSelect(['intra-unit', 'inter-unit', 'bridge'], param_definition_1.ParamDefinition.objectToOptions(InteractionsVisuals)),
};
