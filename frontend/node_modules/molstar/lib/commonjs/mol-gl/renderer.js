...
(function (Renderer) {
    ...
    function create(ctx, props = {}) {
        ...
        const checkEmissive = function (r) {
        ...
        const renderEmissiveOpaque = (group, camera, depthTexture, occludeWithOpaqueDepth) => {
            if (debug_1.isTimingMode)
                ctx.timer.mark('Renderer.renderEmissiveOpaque');
            state.disable(gl.BLEND);
            state.enable(gl.DEPTH_TEST);
            ...
            if (debug_1.isTimingMode)
                ctx.timer.markEnd('Renderer.renderEmissiveOpaque');
        };
        const renderEmissiveTransparent = (group, camera, depthTexture) => {
            if (debug_1.isTimingMode)
                ctx.timer.mark('Renderer.renderEmissiveTransparent');
            ...
            if (debug_1.isTimingMode)
                ctx.timer.markEnd('Renderer.renderEmissiveTransparent');
        };
