...
import type { CameraTransitionManager } from './camera/transition.js';
import { EasingFunction } from '../mol-math/easing.js';
...
export declare const Canvas3DParams: {
    ...
    pointer: PD.Group<PD.Normalize<{
        ...
        emissive: number;
        density: number;
        instanceGranularity: import("../mol-geo/geometry/base.js").InstanceGranularityValue;
        lod: Vec3;
        cellSize: number;
        batchSize: number;
    }>>;
