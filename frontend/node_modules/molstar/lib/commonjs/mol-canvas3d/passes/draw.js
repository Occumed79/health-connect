...
class DrawPass {
    ...
    renderEmissiveBloom(renderer, camera, scene, transparency) {
        var _a;
        ...
        if (occludeWithOpaqueDepth) {
            ...
            (_a = bloom.emissiveTarget.depthRenderbuffer) === null || _a === void 0 ? void 0 : _a.attachFramebuffer(bloom.emissiveTarget.framebuffer);
        }
    }
    _renderBloom(renderer, camera, scene, postprocessingProps) {
        if (!bloom_1.BloomPass.isEnabled(postprocessingProps) || postprocessingProps.bloom.name !== 'on')
            return false;
        const bloom = this.postprocessing.bloom;
    ...
    render(ctx, props, toDrawingBuffer) {
        ...
        const bloomCompositesBackground = !props.transparentBackground && !backgroundEnabled &&
            bloom_1.BloomPass.isEnabled(pp) && pp.bloom.name === 'on' &&
