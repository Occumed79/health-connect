...
const postprocessing_frag_1 = require("../../mol-gl/shader/postprocessing.frag.js");
const color_1 = require("../../mol-util/color/index.js");
const fxaa_1 = require("./fxaa.js");
const smaa_1 = require("./smaa.js");
const debug_1 = require("../../mol-util/debug.js");
const background_1 = require("./background.js");
const cas_1 = require("./cas.js");
const dof_1 = require("./dof.js");
const bloom_1 = require("./bloom.js");
const outline_1 = require("./outline.js");
const shadow_1 = require("./shadow.js");
const ssao_1 = require("./ssao.js");
const PostprocessingSchema = {
    ...
    tBloom: (0, schema_1.TextureSpec)('texture', 'rgba', 'ubyte', 'linear'),
    dBloomEnable: (0, schema_1.DefineSpec)('boolean'),
...
function getPostprocessingRenderable(ctx, colorTexture, transparentColorTexture, depthTextureOpaque, depthTextureTransparent, shadowsTexture, outlinesTexture, ssaoDepthTexture, ssaoDepthTransparentTexture, bloomTexture, transparentOutline) {
    const values = {
        ...util_1.QuadValues,
        ...
        tBloom: mol_util_1.ValueCell.create(bloomTexture),
        dBloomEnable: mol_util_1.ValueCell.create(false),
...
exports.PostprocessingParams = {
    ...
    background: param_definition_1.ParamDefinition.Group(background_1.BackgroundParams, { isFlat: true, hideIf: p => p.enabled === false }),
...
class PostprocessingPass {
    static isEnabled(props) {
        return props.enabled && (ssao_1.SsaoPass.isEnabled(props) || shadow_1.ShadowPass.isEnabled(props) || outline_1.OutlinePass.isEnabled(props) || props.background.variant.name !== 'off' || bloom_1.BloomPass.isEnabled(props));
    }
    static isTransparentDepthRequired(scene, props) {
        return props.enabled && (dof_1.DofPass.isEnabled(props) || outline_1.OutlinePass.isEnabled(props) && PostprocessingPass.isTransparentOutlineEnabled(props) || ssao_1.SsaoPass.isEnabled(props) && PostprocessingPass.isTransparentSsaoEnabled(scene, props) || bloom_1.BloomPass.isEnabled(props)) && scene.opacityAverage < 1;
    }
    static isTransparentOutlineEnabled(props) {
        var _a;
        return props.enabled && outline_1.OutlinePass.isEnabled(props) && ((_a = props.outline.params.includeTransparent) !== null && _a !== void 0 ? _a : true);
    }
    static isTransparentSsaoEnabled(scene, props) {
        return props.enabled && ssao_1.SsaoPass.isEnabled(props) && ssao_1.SsaoPass.isTransparentEnabled(scene, props.occlusion.params);
    }
    static isSsaoEnabled(props) {
        return props.enabled && ssao_1.SsaoPass.isEnabled(props);
    }
    ...
    render(camera, scene, toDrawingBuffer, transparentBackground, backgroundColor, props, light, ambientColor, bloomEnable = false) {
        ...
        if (this.renderable.values.dBloomEnable.ref.value !== bloomEnable) {
            mol_util_1.ValueCell.update(this.renderable.values.dBloomEnable, bloomEnable);
            this.renderable.update();
        }
