...
class IlluminationPass {
    ...
    renderInternal(ctx, props, toDrawingBuffer, forceRenderInput) {
        ...
        if (this.composeRenderable.values.dBloomEnable.ref.value !== bloomActive) {
            needsUpdateCompose = true;
            mol_util_1.ValueCell.update(this.composeRenderable.values.dBloomEnable, bloomActive);
        }
        // background
        ...
        mol_util_1.ValueCell.updateIfChanged(this.composeRenderable.values.uTransparentBackground, props.transparentBackground || compositeBackground);
...
function getComposeRenderable(ctx, colorTexture, normalTexture, shadedTexture, depthTextureOpaque, depthTextureTransparent, outlinesTexture, transparentColorTexture, ssaoDepthOpaqueTexture, ssaoDepthTransparentTexture, bloomTexture, transparentOutline) {
    const values = {
        ...util_1.QuadValues,
