...
const background_frag_1 = require("../../mol-gl/shader/background.frag.js");
const background_vert_1 = require("../../mol-gl/shader/background.vert.js");
...
const mat3_1 = require("../../mol-math/linear-algebra/3d/mat3.js");
...
class BackgroundPass {
    ...
    updateSkybox(camera, props, onload) {
        ...
        if (mat4_1.Mat4.isZero(camera.headRotation)) {
            ...
            mat4_1.Mat4.invert(m, camera.headRotation);
        }
...
function getImageTexture(ctx, assetManager, source, onload) {
    ...
    const asset = source.name === 'url'
        ? (_a = assetManager.tryFindFilename(source.params)) !== null && _a !== void 0 ? _a : assets_1.Asset.getUrlAsset(assetManager, source.params)
        : source.params;
    if (typeof HTMLImageElement === 'undefined') {
